...
fn main() -> anyhow::Result<()> {
    ...
    let download_dir = PathBuf::from("./checkout/elasticsearch-clients-tests/tests");
...
fn branch_version_from_elasticsearch(
    url: &str,
) -> anyhow::Result<(String, String, semver::Version)> {
