...
#[doc = "Builder for the [Features Get Features API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-features-get-features)\n\nGet the features"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Features Reset Features API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-features-reset-features)\n\nReset the features"]
...
impl<'a> Features<'a> {
    ...
    #[doc = "[Features Get Features API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-features-get-features)\n\nGet the features"]
    pub fn get_features<'b>(&'a self) -> FeaturesGetFeatures<'a, 'b> {
        FeaturesGetFeatures::new(self.transport())
    }
    #[doc = "[Features Reset Features API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-features-reset-features)\n\nReset the features"]
    #[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
    #[cfg(feature = "experimental-apis")]
