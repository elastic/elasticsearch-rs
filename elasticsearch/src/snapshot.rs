...
#[doc = "Builder for the [Snapshot Cleanup Repository API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/clean-up-snapshot-repo-api.html)\n\nClean up the snapshot repository"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Snapshot Clone API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/clone-snapshot-api.html)\n\nClone a snapshot"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Snapshot Create API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/create-snapshot-api.html)\n\nCreate a snapshot"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Snapshot Create Repository API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/put-snapshot-repo-api.html)\n\nCreate or update a snapshot repository"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Snapshot Delete API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/delete-snapshot-api.html)\n\nDelete snapshots"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Snapshot Delete Repository API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/delete-snapshot-repo-api.html)\n\nDelete snapshot repositories"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Snapshot Get API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-snapshot-api.html)\n\nGet snapshot information"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Snapshot Get Repository API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-snapshot-repo-api.html)\n\nGet snapshot repository information"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Snapshot Repository Analyze API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/repo-analysis-api.html)\n\nAnalyze a snapshot repository"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Snapshot Repository Verify Integrity API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/verify-repo-integrity-api.html)\n\nVerify the repository integrity"]
...
#[doc = "Builder for the [Snapshot Restore API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/restore-snapshot-api.html)\n\nRestore a snapshot"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Snapshot Status API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-snapshot-status-api.html)\n\nGet the snapshot status"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Snapshot Verify Repository API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/verify-snapshot-repo-api.html)\n\nVerify a snapshot repository"]
#[derive(Clone, Debug)]
...
impl<'a> Snapshot<'a> {
    ...
    #[doc = "[Snapshot Cleanup Repository API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/clean-up-snapshot-repo-api.html)\n\nClean up the snapshot repository"]
    ...
    #[doc = "[Snapshot Clone API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/clone-snapshot-api.html)\n\nClone a snapshot"]
    pub fn clone<'b>(&'a self, parts: SnapshotCloneParts<'b>) -> SnapshotClone<'a, 'b, ()> {
        SnapshotClone::new(self.transport(), parts)
    }
    #[doc = "[Snapshot Create API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/create-snapshot-api.html)\n\nCreate a snapshot"]
    pub fn create<'b>(&'a self, parts: SnapshotCreateParts<'b>) -> SnapshotCreate<'a, 'b, ()> {
        SnapshotCreate::new(self.transport(), parts)
    }
    #[doc = "[Snapshot Create Repository API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/put-snapshot-repo-api.html)\n\nCreate or update a snapshot repository"]
    ...
    #[doc = "[Snapshot Delete API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/delete-snapshot-api.html)\n\nDelete snapshots"]
    pub fn delete<'b>(&'a self, parts: SnapshotDeleteParts<'b>) -> SnapshotDelete<'a, 'b> {
        SnapshotDelete::new(self.transport(), parts)
    }
    #[doc = "[Snapshot Delete Repository API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/delete-snapshot-repo-api.html)\n\nDelete snapshot repositories"]
    ...
    #[doc = "[Snapshot Get API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-snapshot-api.html)\n\nGet snapshot information"]
    pub fn get<'b>(&'a self, parts: SnapshotGetParts<'b>) -> SnapshotGet<'a, 'b> {
        SnapshotGet::new(self.transport(), parts)
    }
    #[doc = "[Snapshot Get Repository API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-snapshot-repo-api.html)\n\nGet snapshot repository information"]
    ...
    #[doc = "[Snapshot Repository Analyze API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/repo-analysis-api.html)\n\nAnalyze a snapshot repository"]
    ...
    #[doc = "[Snapshot Repository Verify Integrity API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/verify-repo-integrity-api.html)\n\nVerify the repository integrity"]
    #[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
    #[cfg(feature = "experimental-apis")]
    ...
    #[doc = "[Snapshot Restore API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/restore-snapshot-api.html)\n\nRestore a snapshot"]
    pub fn restore<'b>(&'a self, parts: SnapshotRestoreParts<'b>) -> SnapshotRestore<'a, 'b, ()> {
        SnapshotRestore::new(self.transport(), parts)
    }
    #[doc = "[Snapshot Status API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-snapshot-status-api.html)\n\nGet the snapshot status"]
    pub fn status<'b>(&'a self, parts: SnapshotStatusParts<'b>) -> SnapshotStatus<'a, 'b> {
        SnapshotStatus::new(self.transport(), parts)
    }
    #[doc = "[Snapshot Verify Repository API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/verify-snapshot-repo-api.html)\n\nVerify a snapshot repository"]
