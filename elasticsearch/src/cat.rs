...
#[doc = "Builder for the [Cat Aliases API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-alias.html)\n\nGet aliases"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Cat Allocation API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-allocation.html)\n\nGet shard allocation information"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Cat Component Templates API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-component-templates.html)\n\nGet component templates"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Cat Count API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-count.html)\n\nGet a document count"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Cat Fielddata API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-fielddata.html)\n\nGet field data cache information"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Cat Health API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-health.html)\n\nGet the cluster health status"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Cat Help API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat.html)\n\nGet CAT help"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Cat Indices API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-indices.html)\n\nGet index information"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Cat Master API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-master.html)\n\nGet master node information"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Cat Ml Data Frame Analytics API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-dfanalytics.html)\n\nGet data frame analytics jobs"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Cat Ml Datafeeds API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-datafeeds.html)\n\nGet datafeeds"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Cat Ml Jobs API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-anomaly-detectors.html)\n\nGet anomaly detection jobs"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Cat Ml Trained Models API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-trained-model.html)\n\nGet trained models"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Cat Nodeattrs API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-nodeattrs.html)\n\nGet node attribute information"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Cat Nodes API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-nodes.html)\n\nGet node information"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Cat Pending Tasks API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-pending-tasks.html)\n\nGet pending task information"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Cat Plugins API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-plugins.html)\n\nGet plugin information"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Cat Recovery API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-recovery.html)\n\nGet shard recovery information"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Cat Repositories API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-repositories.html)\n\nGet snapshot repository information"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Cat Segments API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-segments.html)\n\nGet segment information"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Cat Shards API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-shards.html)\n\nGet shard information"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Cat Snapshots API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-snapshots.html)\n\nGet snapshot information"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Cat Tasks API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-tasks.html)\n\nGet task information"]
...
#[doc = "Builder for the [Cat Templates API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-templates.html)\n\nGet index template information"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Cat Thread Pool API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-thread-pool.html)\n\nGet thread pool statistics"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Cat Transforms API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-transforms.html)\n\nGet transform information"]
#[derive(Clone, Debug)]
...
impl<'a> Cat<'a> {
    ...
    #[doc = "[Cat Aliases API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-alias.html)\n\nGet aliases"]
    pub fn aliases<'b>(&'a self, parts: CatAliasesParts<'b>) -> CatAliases<'a, 'b> {
        CatAliases::new(self.transport(), parts)
    }
    #[doc = "[Cat Allocation API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-allocation.html)\n\nGet shard allocation information"]
    pub fn allocation<'b>(&'a self, parts: CatAllocationParts<'b>) -> CatAllocation<'a, 'b> {
        CatAllocation::new(self.transport(), parts)
    }
    #[doc = "[Cat Component Templates API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-component-templates.html)\n\nGet component templates"]
    ...
    #[doc = "[Cat Count API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-count.html)\n\nGet a document count"]
    pub fn count<'b>(&'a self, parts: CatCountParts<'b>) -> CatCount<'a, 'b> {
        CatCount::new(self.transport(), parts)
    }
    #[doc = "[Cat Fielddata API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-fielddata.html)\n\nGet field data cache information"]
    pub fn fielddata<'b>(&'a self, parts: CatFielddataParts<'b>) -> CatFielddata<'a, 'b> {
        CatFielddata::new(self.transport(), parts)
    }
    #[doc = "[Cat Health API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-health.html)\n\nGet the cluster health status"]
    pub fn health<'b>(&'a self) -> CatHealth<'a, 'b> {
        CatHealth::new(self.transport())
    }
    #[doc = "[Cat Help API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat.html)\n\nGet CAT help"]
    pub fn help<'b>(&'a self) -> CatHelp<'a, 'b> {
        CatHelp::new(self.transport())
    }
    #[doc = "[Cat Indices API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-indices.html)\n\nGet index information"]
    pub fn indices<'b>(&'a self, parts: CatIndicesParts<'b>) -> CatIndices<'a, 'b> {
        CatIndices::new(self.transport(), parts)
    }
    #[doc = "[Cat Master API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-master.html)\n\nGet master node information"]
    pub fn master<'b>(&'a self) -> CatMaster<'a, 'b> {
        CatMaster::new(self.transport())
    }
    #[doc = "[Cat Ml Data Frame Analytics API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-dfanalytics.html)\n\nGet data frame analytics jobs"]
    ...
    #[doc = "[Cat Ml Datafeeds API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-datafeeds.html)\n\nGet datafeeds"]
    pub fn ml_datafeeds<'b>(&'a self, parts: CatMlDatafeedsParts<'b>) -> CatMlDatafeeds<'a, 'b> {
        CatMlDatafeeds::new(self.transport(), parts)
    }
    #[doc = "[Cat Ml Jobs API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-anomaly-detectors.html)\n\nGet anomaly detection jobs"]
    pub fn ml_jobs<'b>(&'a self, parts: CatMlJobsParts<'b>) -> CatMlJobs<'a, 'b> {
        CatMlJobs::new(self.transport(), parts)
    }
    #[doc = "[Cat Ml Trained Models API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-trained-model.html)\n\nGet trained models"]
    ...
    #[doc = "[Cat Nodeattrs API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-nodeattrs.html)\n\nGet node attribute information"]
    pub fn nodeattrs<'b>(&'a self) -> CatNodeattrs<'a, 'b> {
        CatNodeattrs::new(self.transport())
    }
    #[doc = "[Cat Nodes API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-nodes.html)\n\nGet node information"]
    pub fn nodes<'b>(&'a self) -> CatNodes<'a, 'b> {
        CatNodes::new(self.transport())
    }
    #[doc = "[Cat Pending Tasks API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-pending-tasks.html)\n\nGet pending task information"]
    pub fn pending_tasks<'b>(&'a self) -> CatPendingTasks<'a, 'b> {
        CatPendingTasks::new(self.transport())
    }
    #[doc = "[Cat Plugins API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-plugins.html)\n\nGet plugin information"]
    pub fn plugins<'b>(&'a self) -> CatPlugins<'a, 'b> {
        CatPlugins::new(self.transport())
    }
    #[doc = "[Cat Recovery API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-recovery.html)\n\nGet shard recovery information"]
    pub fn recovery<'b>(&'a self, parts: CatRecoveryParts<'b>) -> CatRecovery<'a, 'b> {
        CatRecovery::new(self.transport(), parts)
    }
    #[doc = "[Cat Repositories API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-repositories.html)\n\nGet snapshot repository information"]
    pub fn repositories<'b>(&'a self) -> CatRepositories<'a, 'b> {
        CatRepositories::new(self.transport())
    }
    #[doc = "[Cat Segments API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-segments.html)\n\nGet segment information"]
    pub fn segments<'b>(&'a self, parts: CatSegmentsParts<'b>) -> CatSegments<'a, 'b> {
        CatSegments::new(self.transport(), parts)
    }
    #[doc = "[Cat Shards API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-shards.html)\n\nGet shard information"]
    pub fn shards<'b>(&'a self, parts: CatShardsParts<'b>) -> CatShards<'a, 'b> {
        CatShards::new(self.transport(), parts)
    }
    #[doc = "[Cat Snapshots API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-snapshots.html)\n\nGet snapshot information"]
    pub fn snapshots<'b>(&'a self, parts: CatSnapshotsParts<'b>) -> CatSnapshots<'a, 'b> {
        CatSnapshots::new(self.transport(), parts)
    }
    #[doc = "[Cat Tasks API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-tasks.html)\n\nGet task information"]
    #[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
    #[cfg(feature = "experimental-apis")]
    pub fn tasks<'b>(&'a self) -> CatTasks<'a, 'b> {
        CatTasks::new(self.transport())
    }
    #[doc = "[Cat Templates API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-templates.html)\n\nGet index template information"]
    pub fn templates<'b>(&'a self, parts: CatTemplatesParts<'b>) -> CatTemplates<'a, 'b> {
        CatTemplates::new(self.transport(), parts)
    }
    #[doc = "[Cat Thread Pool API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-thread-pool.html)\n\nGet thread pool statistics"]
    pub fn thread_pool<'b>(&'a self, parts: CatThreadPoolParts<'b>) -> CatThreadPool<'a, 'b> {
        CatThreadPool::new(self.transport(), parts)
    }
    #[doc = "[Cat Transforms API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-transforms.html)\n\nGet transform information"]
