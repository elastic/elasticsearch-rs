...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Ilm Delete Lifecycle API](https://www.elastic.co/guide/en/elasticsearch/reference/7.5/ilm-delete-lifecycle.html)"]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Ilm Explain Lifecycle API](https://www.elastic.co/guide/en/elasticsearch/reference/7.5/ilm-explain-lifecycle.html)"]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Ilm Get Lifecycle API](https://www.elastic.co/guide/en/elasticsearch/reference/7.5/ilm-get-lifecycle.html)"]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Ilm Get Status API](https://www.elastic.co/guide/en/elasticsearch/reference/7.5/ilm-get-status.html)"]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Ilm Move To Step API](https://www.elastic.co/guide/en/elasticsearch/reference/7.5/ilm-move-to-step.html)"]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Ilm Put Lifecycle API](https://www.elastic.co/guide/en/elasticsearch/reference/7.5/ilm-put-lifecycle.html)"]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Ilm Remove Policy API](https://www.elastic.co/guide/en/elasticsearch/reference/7.5/ilm-remove-policy.html)"]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Ilm Retry API](https://www.elastic.co/guide/en/elasticsearch/reference/7.5/ilm-retry-policy.html)"]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Ilm Start API](https://www.elastic.co/guide/en/elasticsearch/reference/7.5/ilm-start.html)"]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Ilm Stop API](https://www.elastic.co/guide/en/elasticsearch/reference/7.5/ilm-stop.html)"]
...
impl<'a> Ilm<'a> {
    ...
    #[doc = "[Ilm Delete Lifecycle API](https://www.elastic.co/guide/en/elasticsearch/reference/7.5/ilm-delete-lifecycle.html)"]
    ...
    #[doc = "[Ilm Explain Lifecycle API](https://www.elastic.co/guide/en/elasticsearch/reference/7.5/ilm-explain-lifecycle.html)"]
    ...
    #[doc = "[Ilm Get Lifecycle API](https://www.elastic.co/guide/en/elasticsearch/reference/7.5/ilm-get-lifecycle.html)"]
    pub fn get_lifecycle<'b>(&'a self, parts: IlmGetLifecycleParts<'b>) -> IlmGetLifecycle<'a, 'b> {
        IlmGetLifecycle::new(&self.client, parts)
    }
    #[doc = "[Ilm Get Status API](https://www.elastic.co/guide/en/elasticsearch/reference/7.5/ilm-get-status.html)"]
    pub fn get_status<'b>(&'a self) -> IlmGetStatus<'a, 'b> {
        IlmGetStatus::new(&self.client)
    }
    #[doc = "[Ilm Move To Step API](https://www.elastic.co/guide/en/elasticsearch/reference/7.5/ilm-move-to-step.html)"]
    pub fn move_to_step<'b>(&'a self, parts: IlmMoveToStepParts<'b>) -> IlmMoveToStep<'a, 'b, ()> {
        IlmMoveToStep::new(&self.client, parts)
    }
    #[doc = "[Ilm Put Lifecycle API](https://www.elastic.co/guide/en/elasticsearch/reference/7.5/ilm-put-lifecycle.html)"]
    ...
    #[doc = "[Ilm Remove Policy API](https://www.elastic.co/guide/en/elasticsearch/reference/7.5/ilm-remove-policy.html)"]
    ...
    #[doc = "[Ilm Retry API](https://www.elastic.co/guide/en/elasticsearch/reference/7.5/ilm-retry-policy.html)"]
    pub fn retry<'b>(&'a self, parts: IlmRetryParts<'b>) -> IlmRetry<'a, 'b, ()> {
        IlmRetry::new(&self.client, parts)
    }
    #[doc = "[Ilm Start API](https://www.elastic.co/guide/en/elasticsearch/reference/7.5/ilm-start.html)"]
    pub fn start<'b>(&'a self) -> IlmStart<'a, 'b, ()> {
        IlmStart::new(&self.client)
    }
    #[doc = "[Ilm Stop API](https://www.elastic.co/guide/en/elasticsearch/reference/7.5/ilm-stop.html)"]
