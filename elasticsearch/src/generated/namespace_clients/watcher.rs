...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Watcher Ack Watch API](http://www.elastic.co/guide/en/elasticsearch/reference/7.5/watcher-api-ack-watch.html)"]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Watcher Activate Watch API](https://www.elastic.co/guide/en/elasticsearch/reference/7.5/watcher-api-activate-watch.html)"]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Watcher Deactivate Watch API](https://www.elastic.co/guide/en/elasticsearch/reference/7.5/watcher-api-deactivate-watch.html)"]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Watcher Delete Watch API](http://www.elastic.co/guide/en/elasticsearch/reference/7.5/watcher-api-delete-watch.html)"]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Watcher Execute Watch API](http://www.elastic.co/guide/en/elasticsearch/reference/7.5/watcher-api-execute-watch.html)"]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Watcher Get Watch API](http://www.elastic.co/guide/en/elasticsearch/reference/7.5/watcher-api-get-watch.html)"]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Watcher Put Watch API](http://www.elastic.co/guide/en/elasticsearch/reference/7.5/watcher-api-put-watch.html)"]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Watcher Start API](http://www.elastic.co/guide/en/elasticsearch/reference/7.5/watcher-api-start.html)"]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Watcher Stats API](http://www.elastic.co/guide/en/elasticsearch/reference/7.5/watcher-api-stats.html)"]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Watcher Stop API](http://www.elastic.co/guide/en/elasticsearch/reference/7.5/watcher-api-stop.html)"]
...
impl<'a> Watcher<'a> {
    ...
    #[doc = "[Watcher Ack Watch API](http://www.elastic.co/guide/en/elasticsearch/reference/7.5/watcher-api-ack-watch.html)"]
    pub fn ack_watch<'b>(&'a self, parts: WatcherAckWatchParts<'b>) -> WatcherAckWatch<'a, 'b, ()> {
        WatcherAckWatch::new(&self.client, parts)
    }
    #[doc = "[Watcher Activate Watch API](https://www.elastic.co/guide/en/elasticsearch/reference/7.5/watcher-api-activate-watch.html)"]
    ...
    #[doc = "[Watcher Deactivate Watch API](https://www.elastic.co/guide/en/elasticsearch/reference/7.5/watcher-api-deactivate-watch.html)"]
    ...
    #[doc = "[Watcher Delete Watch API](http://www.elastic.co/guide/en/elasticsearch/reference/7.5/watcher-api-delete-watch.html)"]
    ...
    #[doc = "[Watcher Execute Watch API](http://www.elastic.co/guide/en/elasticsearch/reference/7.5/watcher-api-execute-watch.html)"]
    ...
    #[doc = "[Watcher Get Watch API](http://www.elastic.co/guide/en/elasticsearch/reference/7.5/watcher-api-get-watch.html)"]
    pub fn get_watch<'b>(&'a self, parts: WatcherGetWatchParts<'b>) -> WatcherGetWatch<'a, 'b> {
        WatcherGetWatch::new(&self.client, parts)
    }
    #[doc = "[Watcher Put Watch API](http://www.elastic.co/guide/en/elasticsearch/reference/7.5/watcher-api-put-watch.html)"]
    pub fn put_watch<'b>(&'a self, parts: WatcherPutWatchParts<'b>) -> WatcherPutWatch<'a, 'b, ()> {
        WatcherPutWatch::new(&self.client, parts)
    }
    #[doc = "[Watcher Start API](http://www.elastic.co/guide/en/elasticsearch/reference/7.5/watcher-api-start.html)"]
    pub fn start<'b>(&'a self) -> WatcherStart<'a, 'b, ()> {
        WatcherStart::new(&self.client)
    }
    #[doc = "[Watcher Stats API](http://www.elastic.co/guide/en/elasticsearch/reference/7.5/watcher-api-stats.html)"]
    pub fn stats<'b>(&'a self, parts: WatcherStatsParts<'b>) -> WatcherStats<'a, 'b> {
        WatcherStats::new(&self.client, parts)
    }
    #[doc = "[Watcher Stop API](http://www.elastic.co/guide/en/elasticsearch/reference/7.5/watcher-api-stop.html)"]
