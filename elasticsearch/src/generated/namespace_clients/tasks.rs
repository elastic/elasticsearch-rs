...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Tasks Cancel API](https://www.elastic.co/guide/en/elasticsearch/reference/master/tasks.html)\n\nCancels a task, if it can be cancelled through an API."]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Tasks Get API](https://www.elastic.co/guide/en/elasticsearch/reference/master/tasks.html)\n\nReturns information about a task."]
...
#[derive(Clone, Debug)]
#[doc = "Builder for the [Tasks List API](https://www.elastic.co/guide/en/elasticsearch/reference/master/tasks.html)\n\nReturns a list of tasks."]
...
impl<'a> Tasks<'a> {
    ...
    #[doc = "[Tasks Cancel API](https://www.elastic.co/guide/en/elasticsearch/reference/master/tasks.html)\n\nCancels a task, if it can be cancelled through an API."]
    pub fn cancel<'b>(&'a self, parts: TasksCancelParts<'b>) -> TasksCancel<'a, 'b, ()> {
        TasksCancel::new(&self.client, parts)
    }
    #[doc = "[Tasks Get API](https://www.elastic.co/guide/en/elasticsearch/reference/master/tasks.html)\n\nReturns information about a task."]
    pub fn get<'b>(&'a self, parts: TasksGetParts<'b>) -> TasksGet<'a, 'b> {
        TasksGet::new(&self.client, parts)
    }
    #[doc = "[Tasks List API](https://www.elastic.co/guide/en/elasticsearch/reference/master/tasks.html)\n\nReturns a list of tasks."]
