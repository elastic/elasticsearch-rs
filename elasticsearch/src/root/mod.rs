...
#[doc = "Builder for the [Reindex Cancel API](https://www.elastic.co/docs/api/doc/elasticsearch#TODO)\n\nCancel a reindex operation"]
...
#[doc = "Builder for the [Reindex Get API](https://www.elastic.co/docs/api/doc/elasticsearch#TODO)\n\nGet information for a reindex operation"]
#[doc = "&nbsp;\n# Optional, beta\nThis requires the `beta-apis` feature. On track to become stable but breaking changes can\nhappen in minor versions.\n        "]
#[cfg(feature = "beta-apis")]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Reindex List API](https://www.elastic.co/docs/api/doc/elasticsearch#TODO)\n\nList all running reindex operations"]
#[doc = "&nbsp;\n# Optional, beta\nThis requires the `beta-apis` feature. On track to become stable but breaking changes can\nhappen in minor versions.\n        "]
#[cfg(feature = "beta-apis")]
#[derive(Clone, Debug)]
...
impl Elasticsearch {
    ...
    #[doc = "[Reindex Cancel API](https://www.elastic.co/docs/api/doc/elasticsearch#TODO)\n\nCancel a reindex operation"]
    #[doc = "&nbsp;\n# Optional, beta\nThis requires the `beta-apis` feature. On track to become stable but breaking changes can\nhappen in minor versions.\n        "]
    #[cfg(feature = "beta-apis")]
    ...
    #[doc = "[Reindex Get API](https://www.elastic.co/docs/api/doc/elasticsearch#TODO)\n\nGet information for a reindex operation"]
    #[doc = "&nbsp;\n# Optional, beta\nThis requires the `beta-apis` feature. On track to become stable but breaking changes can\nhappen in minor versions.\n        "]
    #[cfg(feature = "beta-apis")]
    pub fn reindex_get<'a, 'b>(&'a self, parts: ReindexGetParts<'b>) -> ReindexGet<'a, 'b> {
        ReindexGet::new(self.transport(), parts)
    }
    #[doc = "[Reindex List API](https://www.elastic.co/docs/api/doc/elasticsearch#TODO)\n\nList all running reindex operations"]
    #[doc = "&nbsp;\n# Optional, beta\nThis requires the `beta-apis` feature. On track to become stable but breaking changes can\nhappen in minor versions.\n        "]
    #[cfg(feature = "beta-apis")]
