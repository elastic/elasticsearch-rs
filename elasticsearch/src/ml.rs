...
impl<'b> MlClearTrainedModelDeploymentCacheParts<'b> {
    ...
    pub fn url(self) -> Cow<'static, str> {
        match self {
            MlClearTrainedModelDeploymentCacheParts::ModelId(model_id) => {
                ...
                p.push_str("/deployment/cache/_clear");
                p.into()
            }
        }
    }
}
#[doc = "Builder for the [Ml Clear Trained Model Deployment Cache API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-clear-trained-model-deployment-cache)\n\nClear trained model deployment cache"]
#[derive(Clone, Debug)]
pub struct MlClearTrainedModelDeploymentCache<'a, 'b, B> {
    transport: &'a Transport,
    parts: MlClearTrainedModelDeploymentCacheParts<'b>,
    body: Option<B>,
...
impl<'a, 'b, B> MlClearTrainedModelDeploymentCache<'a, 'b, B>
where
    B: Body,
{
    #[doc = "Creates a new instance of [MlClearTrainedModelDeploymentCache] with the specified API parts"]
    pub fn new(
        transport: &'a Transport,
        parts: MlClearTrainedModelDeploymentCacheParts<'b>,
    ) -> Self {
        let headers = HeaderMap::new();
        MlClearTrainedModelDeploymentCache {
            transport,
            parts,
            headers,
            body: None,
    ...
    pub fn body<T>(self, body: T) -> MlClearTrainedModelDeploymentCache<'a, 'b, JsonBody<T>>
    where
        T: Serialize,
    {
        MlClearTrainedModelDeploymentCache {
    ...
    #[doc = "Creates an asynchronous call to the Ml Clear Trained Model Deployment Cache API that can be awaited"]
...
#[doc = "Builder for the [Ml Close Job API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-close-job)\n\nClose anomaly detection jobs"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Delete Calendar API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-delete-calendar)\n\nDelete a calendar"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Delete Calendar Event API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-delete-calendar-event)\n\nDelete events from a calendar"]
#[derive(Clone, Debug)]
    ...
    pub fn url(self) -> Cow<'static, str> {
        match self {
            MlDeleteCalendarJobParts::CalendarIdJobId(calendar_id, job_id) => {
                let job_id_str = job_id.join(",");
                let encoded_calendar_id: Cow<str> =
                    percent_encode(calendar_id.as_bytes(), PARTS_ENCODED).into();
                let encoded_job_id: Cow<str> =
                    percent_encode(job_id_str.as_bytes(), PARTS_ENCODED).into();
                let mut p = String::with_capacity(
...
#[doc = "Builder for the [Ml Delete Calendar Job API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-delete-calendar-job)\n\nDelete anomaly jobs from a calendar"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Delete Data Frame Analytics API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-delete-data-frame-analytics)\n\nDelete a data frame analytics job"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Delete Datafeed API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-delete-datafeed)\n\nDelete a datafeed"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Delete Expired Data API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-delete-expired-data)\n\nDelete expired ML data"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Delete Filter API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-delete-filter)\n\nDelete a filter"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Delete Forecast API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-delete-forecast)\n\nDelete forecasts from a job"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Delete Job API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-delete-job)\n\nDelete an anomaly detection job"]
#[derive(Clone, Debug)]
pub struct MlDeleteJob<'a, 'b> {
    transport: &'a Transport,
    parts: MlDeleteJobParts<'b>,
    delete_user_annotations: Option<bool>,
    error_trace: Option<bool>,
    filter_path: Option<&'b [&'b str]>,
    force: Option<bool>,
    headers: HeaderMap,
...
impl<'a, 'b> MlDeleteJob<'a, 'b> {
    ...
    #[doc = "Should annotations added by the user be deleted"]
    pub fn delete_user_annotations(mut self, delete_user_annotations: bool) -> Self {
        self.delete_user_annotations = Some(delete_user_annotations);
        self
    }
    #[doc = "Include the stack trace of returned errors."]
    pub fn error_trace(mut self, error_trace: bool) -> Self {
    ...
    pub async fn send(self) -> Result<Response, Error> {
        ...
        let query_string = {
            ...
            let query_params = QueryParams {
                delete_user_annotations: self.delete_user_annotations,
                error_trace: self.error_trace,
                filter_path: self.filter_path,
                force: self.force,
                human: self.human,
...
#[doc = "Builder for the [Ml Delete Model Snapshot API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-delete-model-snapshot)\n\nDelete a model snapshot"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Delete Trained Model API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-delete-trained-model)\n\nDelete an unreferenced trained model"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Delete Trained Model Alias API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-delete-trained-model-alias)\n\nDelete a trained model alias"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Estimate Model Memory API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-estimate-model-memory)\n\nEstimate job model memory usage"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Evaluate Data Frame API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-evaluate-data-frame)\n\nEvaluate data frame analytics"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Explain Data Frame Analytics API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-explain-data-frame-analytics)\n\nExplain data frame analytics config"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Flush Job API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-flush-job)\n\nForce buffered data to be processed"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Forecast API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-forecast)\n\nPredict future behavior of a time series"]
#[derive(Clone, Debug)]
        ...
        match self {
            MlGetBucketsParts::JobIdTimestamp(job_id, timestamp) => {
                ...
                let encoded_timestamp: Cow<str> =
                    percent_encode(timestamp_str.as_bytes(), PARTS_ENCODED).into();
                let mut p =
...
#[doc = "Builder for the [Ml Get Buckets API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-buckets)\n\nGet anomaly detection job results for buckets"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Get Calendar Events API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-calendar-events)\n\nGet info about events in calendars"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Get Calendars API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-calendars)\n\nGet calendar configuration info"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Get Categories API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-categories)\n\nGet anomaly detection job results for categories"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Get Data Frame Analytics API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-data-frame-analytics)\n\nGet data frame analytics job configuration info"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Get Data Frame Analytics Stats API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-data-frame-analytics-stats)\n\nGet data frame analytics job stats"]
#[derive(Clone, Debug)]
    ...
    pub fn url(self) -> Cow<'static, str> {
        match self {
            MlGetDatafeedStatsParts::DatafeedId(datafeed_id) => {
                let datafeed_id_str = datafeed_id.join(",");
                let encoded_datafeed_id: Cow<str> =
                    percent_encode(datafeed_id_str.as_bytes(), PARTS_ENCODED).into();
...
#[doc = "Builder for the [Ml Get Datafeed Stats API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-datafeed-stats)\n\nGet datafeed stats"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Get Datafeeds API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-datafeeds)\n\nGet datafeeds configuration info"]
#[derive(Clone, Debug)]
    ...
    pub fn url(self) -> Cow<'static, str> {
        match self {
            ...
            MlGetFiltersParts::FilterId(filter_id) => {
                let filter_id_str = filter_id.join(",");
                let encoded_filter_id: Cow<str> =
                    percent_encode(filter_id_str.as_bytes(), PARTS_ENCODED).into();
                let mut p = String::with_capacity(13usize + encoded_filter_id.len());
                p.push_str("/_ml/filters/");
                p.push_str(encoded_filter_id.as_ref());
                p.into()
...
#[doc = "Builder for the [Ml Get Filters API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-filters)\n\nGet filters"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Get Influencers API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-influencers)\n\nGet anomaly detection job results for influencers"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Get Job Stats API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-job-stats)\n\nGet anomaly detection job stats"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Get Jobs API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-jobs)\n\nGet anomaly detection jobs configuration info"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Get Memory Stats API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-memory-stats)\n\nGet machine learning memory usage info"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Get Model Snapshot Upgrade Stats API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-model-snapshot-upgrade-stats)\n\nGet anomaly detection job model snapshot upgrade usage info"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Get Model Snapshots API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-model-snapshots)\n\nGet model snapshots info"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Get Overall Buckets API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-overall-buckets)\n\nGet overall bucket results"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Get Records API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-records)\n\nGet anomaly records for an anomaly detection job"]
#[derive(Clone, Debug)]
    ...
    pub fn url(self) -> Cow<'static, str> {
        match self {
            MlGetTrainedModelsParts::ModelId(model_id) => {
                let model_id_str = model_id.join(",");
                let encoded_model_id: Cow<str> =
                    percent_encode(model_id_str.as_bytes(), PARTS_ENCODED).into();
                let mut p = String::with_capacity(20usize + encoded_model_id.len());
                p.push_str("/_ml/trained_models/");
                p.push_str(encoded_model_id.as_ref());
                p.into()
...
#[doc = "Builder for the [Ml Get Trained Models API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-trained-models)\n\nGet trained model configuration info"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Get Trained Models Stats API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-trained-models-stats)\n\nGet trained models usage info"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Infer Trained Model API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-infer-trained-model)\n\nEvaluate a trained model"]
#[derive(Clone, Debug)]
    ...
    B: Body,
{
    ...
    #[doc = "Controls the amount of time to wait for inference results."]
    pub fn timeout(mut self, timeout: &'b str) -> Self {
        self.timeout = Some(timeout);
        self
    }
...
#[doc = "Builder for the [Ml Info API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-info)\n\nGet machine learning information"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Open Job API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-open-job)\n\nOpen anomaly detection jobs"]
#[derive(Clone, Debug)]
    ...
    B: Body,
{
    ...
    #[doc = "Controls the time to wait until a job has opened."]
    pub fn timeout(mut self, timeout: &'b str) -> Self {
        self.timeout = Some(timeout);
        self
    }
...
#[doc = "Builder for the [Ml Post Calendar Events API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-post-calendar-events)\n\nAdd scheduled events to the calendar"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Post Data API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-post-data)\n\nSend data to an anomaly detection job for analysis"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Preview Data Frame Analytics API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-preview-data-frame-analytics)\n\nPreview features used by data frame analytics"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Preview Datafeed API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-preview-datafeed)\n\nPreview a datafeed"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Put Calendar API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-put-calendar)\n\nCreate a calendar"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Put Calendar Job API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-put-calendar-job)\n\nAdd anomaly detection job to calendar"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Put Data Frame Analytics API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-put-data-frame-analytics)\n\nCreate a data frame analytics job"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Put Datafeed API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-put-datafeed)\n\nCreate a datafeed"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Put Filter API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-put-filter)\n\nCreate a filter"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Put Job API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-put-job)\n\nCreate an anomaly detection job"]
#[derive(Clone, Debug)]
    ...
    B: Body,
{
    ...
    #[doc = "Whether to allow (1) wildcard index expressions that match no indices and (2) requests where the final resolved set is empty. Only set if datafeed_config is provided."]
    pub fn allow_no_indices(mut self, allow_no_indices: bool) -> Self {
        self.allow_no_indices = Some(allow_no_indices);
        self
    }
...
#[doc = "Builder for the [Ml Put Trained Model API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-put-trained-model)\n\nCreate a trained model"]
#[derive(Clone, Debug)]
    ...
    B: Body,
{
    ...
    #[doc = "Whether to wait for all child operations(e.g. model download) to complete, before returning or not. Default to false"]
    pub fn wait_for_completion(mut self, wait_for_completion: bool) -> Self {
        self.wait_for_completion = Some(wait_for_completion);
        self
    }
...
#[doc = "Builder for the [Ml Put Trained Model Alias API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-put-trained-model-alias)\n\nCreate or update a trained model alias"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Put Trained Model Definition Part API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-put-trained-model-definition-part)\n\nCreate part of a trained model definition"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Put Trained Model Vocabulary API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-put-trained-model-vocabulary)\n\nCreate a trained model vocabulary"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Reset Job API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-reset-job)\n\nReset an anomaly detection job"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Revert Model Snapshot API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-revert-model-snapshot)\n\nRevert to a snapshot"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Set Upgrade Mode API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-set-upgrade-mode)\n\nSet upgrade_mode for ML indices"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Start Data Frame Analytics API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-start-data-frame-analytics)\n\nStart a data frame analytics job"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Start Datafeed API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-start-datafeed)\n\nStart datafeeds"]
#[derive(Clone, Debug)]
...
impl<'b> MlStartTrainedModelDeploymentParts<'b> {
    ...
    pub fn url(self) -> Cow<'static, str> {
        match self {
            MlStartTrainedModelDeploymentParts::ModelId(model_id) => {
                ...
                p.push_str("/_ml/trained_models/");
                p.push_str(encoded_model_id.as_ref());
                p.push_str("/deployment/_start");
                p.into()
            }
        }
    }
}
#[doc = "Builder for the [Ml Start Trained Model Deployment API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-start-trained-model-deployment)\n\nStart a trained model deployment"]
#[derive(Clone, Debug)]
pub struct MlStartTrainedModelDeployment<'a, 'b, B> {
    transport: &'a Transport,
    parts: MlStartTrainedModelDeploymentParts<'b>,
    body: Option<B>,
    cache_size: Option<&'b str>,
    deployment_id: Option<&'b str>,
    error_trace: Option<bool>,
    filter_path: Option<&'b [&'b str]>,
    headers: HeaderMap,
    human: Option<bool>,
...
where
    B: Body,
{
    #[doc = "Creates a new instance of [MlStartTrainedModelDeployment] with the specified API parts"]
    pub fn new(transport: &'a Transport, parts: MlStartTrainedModelDeploymentParts<'b>) -> Self {
        let headers = HeaderMap::new();
        MlStartTrainedModelDeployment {
            transport,
            parts,
            headers,
            body: None,
    ...
    #[doc = "The body for the API call"]
    pub fn body<T>(self, body: T) -> MlStartTrainedModelDeployment<'a, 'b, JsonBody<T>>
    where
        T: Serialize,
    {
        MlStartTrainedModelDeployment {
    ...
    #[doc = "The Id of the new deployment. Defaults to the model_id if not set."]
    pub fn deployment_id(mut self, deployment_id: &'b str) -> Self {
    ...
    #[doc = "The total number of allocations this model is assigned across machine learning nodes."]
...
#[doc = "Builder for the [Ml Stop Data Frame Analytics API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-stop-data-frame-analytics)\n\nStop data frame analytics jobs"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Stop Datafeed API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-stop-datafeed)\n\nStop datafeeds"]
#[derive(Clone, Debug)]
    ...
    B: Body,
{
    ...
    #[doc = "True if the job associated with the datafeed should be closed."]
    pub fn close_job(mut self, close_job: bool) -> Self {
        self.close_job = Some(close_job);
        self
    }
    #[doc = "Include the stack trace of returned errors."]
    pub fn error_trace(mut self, error_trace: bool) -> Self {
...
impl<'b> MlStopTrainedModelDeploymentParts<'b> {
    ...
    pub fn url(self) -> Cow<'static, str> {
        match self {
            MlStopTrainedModelDeploymentParts::ModelId(model_id) => {
                ...
                p.push_str("/_ml/trained_models/");
                p.push_str(encoded_model_id.as_ref());
                p.push_str("/deployment/_stop");
                p.into()
            }
        }
    }
}
#[doc = "Builder for the [Ml Stop Trained Model Deployment API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-stop-trained-model-deployment)\n\nStop a trained model deployment"]
#[derive(Clone, Debug)]
...
impl<'a, 'b, B> MlStopTrainedModelDeployment<'a, 'b, B>
where
    B: Body,
{
    #[doc = "Creates a new instance of [MlStopTrainedModelDeployment] with the specified API parts"]
    ...
    #[doc = "Creates an asynchronous call to the Ml Stop Trained Model Deployment API that can be awaited"]
    pub async fn send(self) -> Result<Response, Error> {
        let path = self.parts.url();
        let method = http::Method::Post;
        let headers = self.headers;
...
#[doc = "Builder for the [Ml Update Data Frame Analytics API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-update-data-frame-analytics)\n\nUpdate a data frame analytics job"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Update Datafeed API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-update-datafeed)\n\nUpdate a datafeed"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Update Filter API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-update-filter)\n\nUpdate a filter"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Update Job API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-update-job)\n\nUpdate an anomaly detection job"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Update Model Snapshot API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-update-model-snapshot)\n\nUpdate a snapshot"]
#[derive(Clone, Debug)]
...
impl<'b> MlUpdateTrainedModelDeploymentParts<'b> {
    ...
    pub fn url(self) -> Cow<'static, str> {
        match self {
            MlUpdateTrainedModelDeploymentParts::ModelId(model_id) => {
                ...
                p.push_str("/_ml/trained_models/");
                p.push_str(encoded_model_id.as_ref());
                p.push_str("/deployment/_update");
                p.into()
            }
        }
    }
}
#[doc = "Builder for the [Ml Update Trained Model Deployment API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-update-trained-model-deployment)\n\nUpdate a trained model deployment"]
#[derive(Clone, Debug)]
pub struct MlUpdateTrainedModelDeployment<'a, 'b, B> {
    transport: &'a Transport,
    parts: MlUpdateTrainedModelDeploymentParts<'b>,
    body: Option<B>,
    error_trace: Option<bool>,
    filter_path: Option<&'b [&'b str]>,
    headers: HeaderMap,
...
impl<'a, 'b, B> MlUpdateTrainedModelDeployment<'a, 'b, B>
where
    B: Body,
{
    #[doc = "Creates a new instance of [MlUpdateTrainedModelDeployment] with the specified API parts"]
    pub fn new(transport: &'a Transport, parts: MlUpdateTrainedModelDeploymentParts<'b>) -> Self {
        let headers = HeaderMap::new();
        MlUpdateTrainedModelDeployment {
            transport,
            parts,
            headers,
            body: None,
    ...
    #[doc = "The body for the API call"]
    pub fn body<T>(self, body: T) -> MlUpdateTrainedModelDeployment<'a, 'b, JsonBody<T>>
    where
        T: Serialize,
    {
        MlUpdateTrainedModelDeployment {
    ...
    #[doc = "Update the model deployment to this number of allocations."]
    pub fn number_of_allocations(mut self, number_of_allocations: i32) -> Self {
        self.number_of_allocations = Some(number_of_allocations);
        self
    }
    ...
    #[doc = "Creates an asynchronous call to the Ml Update Trained Model Deployment API that can be awaited"]
    pub async fn send(self) -> Result<Response, Error> {
        let path = self.parts.url();
        let method = http::Method::Post;
        let headers = self.headers;
...
#[doc = "Builder for the [Ml Upgrade Job Snapshot API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-upgrade-job-snapshot)\n\nUpgrade a snapshot"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ml Validate API](https://www.elastic.co/guide/en/machine-learning/9.1/ml-jobs.html)\n\nValidate an anomaly detection job"]
#[derive(Clone, Debug)]
...
impl<'a> Ml<'a> {
    ...
    #[doc = "[Ml Clear Trained Model Deployment Cache API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-clear-trained-model-deployment-cache)\n\nClear trained model deployment cache"]
    pub fn clear_trained_model_deployment_cache<'b>(
        &'a self,
        parts: MlClearTrainedModelDeploymentCacheParts<'b>,
    ) -> MlClearTrainedModelDeploymentCache<'a, 'b, ()> {
        MlClearTrainedModelDeploymentCache::new(self.transport(), parts)
    }
    #[doc = "[Ml Close Job API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-close-job)\n\nClose anomaly detection jobs"]
    pub fn close_job<'b>(&'a self, parts: MlCloseJobParts<'b>) -> MlCloseJob<'a, 'b, ()> {
        MlCloseJob::new(self.transport(), parts)
    }
    #[doc = "[Ml Delete Calendar API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-delete-calendar)\n\nDelete a calendar"]
    ...
    #[doc = "[Ml Delete Calendar Event API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-delete-calendar-event)\n\nDelete events from a calendar"]
    ...
    #[doc = "[Ml Delete Calendar Job API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-delete-calendar-job)\n\nDelete anomaly jobs from a calendar"]
    ...
    #[doc = "[Ml Delete Data Frame Analytics API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-delete-data-frame-analytics)\n\nDelete a data frame analytics job"]
    ...
    #[doc = "[Ml Delete Datafeed API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-delete-datafeed)\n\nDelete a datafeed"]
    ...
    #[doc = "[Ml Delete Expired Data API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-delete-expired-data)\n\nDelete expired ML data"]
    ...
    #[doc = "[Ml Delete Filter API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-delete-filter)\n\nDelete a filter"]
    pub fn delete_filter<'b>(&'a self, parts: MlDeleteFilterParts<'b>) -> MlDeleteFilter<'a, 'b> {
        MlDeleteFilter::new(self.transport(), parts)
    }
    #[doc = "[Ml Delete Forecast API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-delete-forecast)\n\nDelete forecasts from a job"]
    ...
    #[doc = "[Ml Delete Job API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-delete-job)\n\nDelete an anomaly detection job"]
    pub fn delete_job<'b>(&'a self, parts: MlDeleteJobParts<'b>) -> MlDeleteJob<'a, 'b> {
        MlDeleteJob::new(self.transport(), parts)
    }
    #[doc = "[Ml Delete Model Snapshot API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-delete-model-snapshot)\n\nDelete a model snapshot"]
    ...
    #[doc = "[Ml Delete Trained Model API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-delete-trained-model)\n\nDelete an unreferenced trained model"]
    ...
    #[doc = "[Ml Delete Trained Model Alias API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-delete-trained-model-alias)\n\nDelete a trained model alias"]
    ...
    #[doc = "[Ml Estimate Model Memory API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-estimate-model-memory)\n\nEstimate job model memory usage"]
    pub fn estimate_model_memory<'b>(&'a self) -> MlEstimateModelMemory<'a, 'b, ()> {
        MlEstimateModelMemory::new(self.transport())
    }
    #[doc = "[Ml Evaluate Data Frame API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-evaluate-data-frame)\n\nEvaluate data frame analytics"]
    pub fn evaluate_data_frame<'b>(&'a self) -> MlEvaluateDataFrame<'a, 'b, ()> {
        MlEvaluateDataFrame::new(self.transport())
    }
    #[doc = "[Ml Explain Data Frame Analytics API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-explain-data-frame-analytics)\n\nExplain data frame analytics config"]
    ...
    #[doc = "[Ml Flush Job API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-flush-job)\n\nForce buffered data to be processed"]
    pub fn flush_job<'b>(&'a self, parts: MlFlushJobParts<'b>) -> MlFlushJob<'a, 'b, ()> {
        MlFlushJob::new(self.transport(), parts)
    }
    #[doc = "[Ml Forecast API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-forecast)\n\nPredict future behavior of a time series"]
    pub fn forecast<'b>(&'a self, parts: MlForecastParts<'b>) -> MlForecast<'a, 'b, ()> {
        MlForecast::new(self.transport(), parts)
    }
    #[doc = "[Ml Get Buckets API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-buckets)\n\nGet anomaly detection job results for buckets"]
    pub fn get_buckets<'b>(&'a self, parts: MlGetBucketsParts<'b>) -> MlGetBuckets<'a, 'b, ()> {
        MlGetBuckets::new(self.transport(), parts)
    }
    #[doc = "[Ml Get Calendar Events API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-calendar-events)\n\nGet info about events in calendars"]
    ...
    #[doc = "[Ml Get Calendars API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-calendars)\n\nGet calendar configuration info"]
    ...
    #[doc = "[Ml Get Categories API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-categories)\n\nGet anomaly detection job results for categories"]
    ...
    #[doc = "[Ml Get Data Frame Analytics API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-data-frame-analytics)\n\nGet data frame analytics job configuration info"]
    ...
    #[doc = "[Ml Get Data Frame Analytics Stats API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-data-frame-analytics-stats)\n\nGet data frame analytics job stats"]
    ...
    #[doc = "[Ml Get Datafeed Stats API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-datafeed-stats)\n\nGet datafeed stats"]
    ...
    #[doc = "[Ml Get Datafeeds API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-datafeeds)\n\nGet datafeeds configuration info"]
    pub fn get_datafeeds<'b>(&'a self, parts: MlGetDatafeedsParts<'b>) -> MlGetDatafeeds<'a, 'b> {
        MlGetDatafeeds::new(self.transport(), parts)
    }
    #[doc = "[Ml Get Filters API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-filters)\n\nGet filters"]
    pub fn get_filters<'b>(&'a self, parts: MlGetFiltersParts<'b>) -> MlGetFilters<'a, 'b> {
        MlGetFilters::new(self.transport(), parts)
    }
    #[doc = "[Ml Get Influencers API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-influencers)\n\nGet anomaly detection job results for influencers"]
    ...
    #[doc = "[Ml Get Job Stats API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-job-stats)\n\nGet anomaly detection job stats"]
    pub fn get_job_stats<'b>(&'a self, parts: MlGetJobStatsParts<'b>) -> MlGetJobStats<'a, 'b> {
        MlGetJobStats::new(self.transport(), parts)
    }
    #[doc = "[Ml Get Jobs API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-jobs)\n\nGet anomaly detection jobs configuration info"]
    pub fn get_jobs<'b>(&'a self, parts: MlGetJobsParts<'b>) -> MlGetJobs<'a, 'b> {
        MlGetJobs::new(self.transport(), parts)
    }
    #[doc = "[Ml Get Memory Stats API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-memory-stats)\n\nGet machine learning memory usage info"]
    ...
    #[doc = "[Ml Get Model Snapshot Upgrade Stats API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-model-snapshot-upgrade-stats)\n\nGet anomaly detection job model snapshot upgrade usage info"]
    ...
    #[doc = "[Ml Get Model Snapshots API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-model-snapshots)\n\nGet model snapshots info"]
    ...
    #[doc = "[Ml Get Overall Buckets API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-overall-buckets)\n\nGet overall bucket results"]
    ...
    #[doc = "[Ml Get Records API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-records)\n\nGet anomaly records for an anomaly detection job"]
    pub fn get_records<'b>(&'a self, parts: MlGetRecordsParts<'b>) -> MlGetRecords<'a, 'b, ()> {
        MlGetRecords::new(self.transport(), parts)
    }
    #[doc = "[Ml Get Trained Models API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-trained-models)\n\nGet trained model configuration info"]
    ...
    #[doc = "[Ml Get Trained Models Stats API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-get-trained-models-stats)\n\nGet trained models usage info"]
    ...
    #[doc = "[Ml Infer Trained Model API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-infer-trained-model)\n\nEvaluate a trained model"]
    ...
    #[doc = "[Ml Info API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-info)\n\nGet machine learning information"]
    pub fn info<'b>(&'a self) -> MlInfo<'a, 'b> {
        MlInfo::new(self.transport())
    }
    #[doc = "[Ml Open Job API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-open-job)\n\nOpen anomaly detection jobs"]
    pub fn open_job<'b>(&'a self, parts: MlOpenJobParts<'b>) -> MlOpenJob<'a, 'b, ()> {
        MlOpenJob::new(self.transport(), parts)
    }
    #[doc = "[Ml Post Calendar Events API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-post-calendar-events)\n\nAdd scheduled events to the calendar"]
    ...
    #[doc = "[Ml Post Data API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-post-data)\n\nSend data to an anomaly detection job for analysis"]
    pub fn post_data<'b>(&'a self, parts: MlPostDataParts<'b>) -> MlPostData<'a, 'b, ()> {
        MlPostData::new(self.transport(), parts)
    }
    #[doc = "[Ml Preview Data Frame Analytics API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-preview-data-frame-analytics)\n\nPreview features used by data frame analytics"]
    ...
    #[doc = "[Ml Preview Datafeed API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-preview-datafeed)\n\nPreview a datafeed"]
    ...
    #[doc = "[Ml Put Calendar API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-put-calendar)\n\nCreate a calendar"]
    pub fn put_calendar<'b>(&'a self, parts: MlPutCalendarParts<'b>) -> MlPutCalendar<'a, 'b, ()> {
        MlPutCalendar::new(self.transport(), parts)
    }
    #[doc = "[Ml Put Calendar Job API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-put-calendar-job)\n\nAdd anomaly detection job to calendar"]
    ...
    #[doc = "[Ml Put Data Frame Analytics API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-put-data-frame-analytics)\n\nCreate a data frame analytics job"]
    ...
    #[doc = "[Ml Put Datafeed API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-put-datafeed)\n\nCreate a datafeed"]
    pub fn put_datafeed<'b>(&'a self, parts: MlPutDatafeedParts<'b>) -> MlPutDatafeed<'a, 'b, ()> {
        MlPutDatafeed::new(self.transport(), parts)
    }
    #[doc = "[Ml Put Filter API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-put-filter)\n\nCreate a filter"]
    pub fn put_filter<'b>(&'a self, parts: MlPutFilterParts<'b>) -> MlPutFilter<'a, 'b, ()> {
        MlPutFilter::new(self.transport(), parts)
    }
    #[doc = "[Ml Put Job API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-put-job)\n\nCreate an anomaly detection job"]
    pub fn put_job<'b>(&'a self, parts: MlPutJobParts<'b>) -> MlPutJob<'a, 'b, ()> {
        MlPutJob::new(self.transport(), parts)
    }
    #[doc = "[Ml Put Trained Model API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-put-trained-model)\n\nCreate a trained model"]
    ...
    #[doc = "[Ml Put Trained Model Alias API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-put-trained-model-alias)\n\nCreate or update a trained model alias"]
    ...
    #[doc = "[Ml Put Trained Model Definition Part API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-put-trained-model-definition-part)\n\nCreate part of a trained model definition"]
    ...
    #[doc = "[Ml Put Trained Model Vocabulary API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-put-trained-model-vocabulary)\n\nCreate a trained model vocabulary"]
    ...
    #[doc = "[Ml Reset Job API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-reset-job)\n\nReset an anomaly detection job"]
    pub fn reset_job<'b>(&'a self, parts: MlResetJobParts<'b>) -> MlResetJob<'a, 'b, ()> {
        MlResetJob::new(self.transport(), parts)
    }
    #[doc = "[Ml Revert Model Snapshot API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-revert-model-snapshot)\n\nRevert to a snapshot"]
    ...
    #[doc = "[Ml Set Upgrade Mode API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-set-upgrade-mode)\n\nSet upgrade_mode for ML indices"]
    pub fn set_upgrade_mode<'b>(&'a self) -> MlSetUpgradeMode<'a, 'b, ()> {
        MlSetUpgradeMode::new(self.transport())
    }
    #[doc = "[Ml Start Data Frame Analytics API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-start-data-frame-analytics)\n\nStart a data frame analytics job"]
    ...
    #[doc = "[Ml Start Datafeed API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-start-datafeed)\n\nStart datafeeds"]
    ...
    #[doc = "[Ml Start Trained Model Deployment API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-start-trained-model-deployment)\n\nStart a trained model deployment"]
    pub fn start_trained_model_deployment<'b>(
        &'a self,
        parts: MlStartTrainedModelDeploymentParts<'b>,
    ) -> MlStartTrainedModelDeployment<'a, 'b, ()> {
        MlStartTrainedModelDeployment::new(self.transport(), parts)
    }
    #[doc = "[Ml Stop Data Frame Analytics API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-stop-data-frame-analytics)\n\nStop data frame analytics jobs"]
    ...
    #[doc = "[Ml Stop Datafeed API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-stop-datafeed)\n\nStop datafeeds"]
    ...
    #[doc = "[Ml Stop Trained Model Deployment API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-stop-trained-model-deployment)\n\nStop a trained model deployment"]
    pub fn stop_trained_model_deployment<'b>(
        &'a self,
        parts: MlStopTrainedModelDeploymentParts<'b>,
    ) -> MlStopTrainedModelDeployment<'a, 'b, ()> {
        MlStopTrainedModelDeployment::new(self.transport(), parts)
    }
    #[doc = "[Ml Update Data Frame Analytics API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-update-data-frame-analytics)\n\nUpdate a data frame analytics job"]
    ...
    #[doc = "[Ml Update Datafeed API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-update-datafeed)\n\nUpdate a datafeed"]
    ...
    #[doc = "[Ml Update Filter API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-update-filter)\n\nUpdate a filter"]
    ...
    #[doc = "[Ml Update Job API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-update-job)\n\nUpdate an anomaly detection job"]
    pub fn update_job<'b>(&'a self, parts: MlUpdateJobParts<'b>) -> MlUpdateJob<'a, 'b, ()> {
        MlUpdateJob::new(self.transport(), parts)
    }
    #[doc = "[Ml Update Model Snapshot API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-update-model-snapshot)\n\nUpdate a snapshot"]
    ...
    #[doc = "[Ml Update Trained Model Deployment API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-update-trained-model-deployment)\n\nUpdate a trained model deployment"]
    pub fn update_trained_model_deployment<'b>(
        &'a self,
        parts: MlUpdateTrainedModelDeploymentParts<'b>,
    ) -> MlUpdateTrainedModelDeployment<'a, 'b, ()> {
        MlUpdateTrainedModelDeployment::new(self.transport(), parts)
    }
    #[doc = "[Ml Upgrade Job Snapshot API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-upgrade-job-snapshot)\n\nUpgrade a snapshot"]
    ...
    #[doc = "[Ml Validate API](https://www.elastic.co/guide/en/machine-learning/9.1/ml-jobs.html)\n\nValidate an anomaly detection job"]
