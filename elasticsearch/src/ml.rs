...
#[derive(Debug, Clone, PartialEq)]
#[doc = "API parts for the Ml Find File Structure API"]
pub enum MlFindFileStructureParts {
    #[doc = "No parts"]
    None,
}
#[cfg(feature = "experimental-apis")]
impl MlFindFileStructureParts {
    #[doc = "Builds a relative URL path to the Ml Find File Structure API"]
    pub fn url(self) -> Cow<'static, str> {
        match self {
            MlFindFileStructureParts::None => "/_ml/find_file_structure".into(),
        }
    }
}
#[doc = "Builder for the [Ml Find File Structure API](https://www.elastic.co/guide/en/elasticsearch/reference/7.11/ml-find-file-structure.html)\n\nFinds the structure of a text file. The text file must contain data that is suitable to be ingested into Elasticsearch."]
#[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
#[cfg(feature = "experimental-apis")]
#[derive(Clone, Debug)]
pub struct MlFindFileStructure<'a, 'b, B> {
    transport: &'a Transport,
    parts: MlFindFileStructureParts,
    body: Option<B>,
...
#[cfg(feature = "experimental-apis")]
impl<'a, 'b, B> MlFindFileStructure<'a, 'b, B>
where
    B: Body,
{
    #[doc = "Creates a new instance of [MlFindFileStructure]"]
    pub fn new(transport: &'a Transport) -> Self {
        let headers = HeaderMap::new();
        MlFindFileStructure {
            transport,
            parts: MlFindFileStructureParts::None,
            headers,
            body: None,
            charset: None,
            column_names: None,
    ...
    #[doc = "The body for the API call"]
    pub fn body<T>(self, body: Vec<T>) -> MlFindFileStructure<'a, 'b, NdBody<T>>
    where
        T: Body,
    {
        MlFindFileStructure {
...
impl<'a> Ml<'a> {
    ...
    #[doc = "[Ml Find File Structure API](https://www.elastic.co/guide/en/elasticsearch/reference/7.11/ml-find-file-structure.html)\n\nFinds the structure of a text file. The text file must contain data that is suitable to be ingested into Elasticsearch."]
    #[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
    #[cfg(feature = "experimental-apis")]
    pub fn find_file_structure<'b>(&'a self) -> MlFindFileStructure<'a, 'b, ()> {
        MlFindFileStructure::new(self.transport())
    }
