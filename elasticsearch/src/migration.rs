...
#[doc = "Builder for the [Migration Deprecations API](https://www.elastic.co/guide/en/elasticsearch/reference/7.17/migration-api-deprecation.html)\n\nRetrieves information about different cluster, node, and index level settings that use deprecated features that will be removed or changed in the next major version."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Migration Get Feature Upgrade Status API](https://www.elastic.co/guide/en/elasticsearch/reference/7.17/migration-api-feature-upgrade.html)\n\nFind out whether system features need to be upgraded or not"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Migration Post Feature Upgrade API](https://www.elastic.co/guide/en/elasticsearch/reference/7.17/migration-api-feature-upgrade.html)\n\nBegin upgrades for system features"]
#[derive(Clone, Debug)]
...
impl<'a> Migration<'a> {
    ...
    #[doc = "[Migration Deprecations API](https://www.elastic.co/guide/en/elasticsearch/reference/7.17/migration-api-deprecation.html)\n\nRetrieves information about different cluster, node, and index level settings that use deprecated features that will be removed or changed in the next major version."]
    ...
    #[doc = "[Migration Get Feature Upgrade Status API](https://www.elastic.co/guide/en/elasticsearch/reference/7.17/migration-api-feature-upgrade.html)\n\nFind out whether system features need to be upgraded or not"]
    ...
    #[doc = "[Migration Post Feature Upgrade API](https://www.elastic.co/guide/en/elasticsearch/reference/7.17/migration-api-feature-upgrade.html)\n\nBegin upgrades for system features"]
