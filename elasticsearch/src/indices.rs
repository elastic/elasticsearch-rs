        ...
        match self {
            IndicesAddBlockParts::IndexBlock(index, block) => {
                ...
                let encoded_block: Cow<str> =
                    percent_encode(block_str.as_bytes(), PARTS_ENCODED).into();
                let mut p =
...
#[doc = "Builder for the [Indices Add Block API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-add-block)\n\nAdd an index block"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Analyze API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-analyze)\n\nGet tokens from text analysis"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Cancel Migrate Reindex API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-cancel-migrate-reindex)\n\nCancel a migration reindex operation"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Clear Cache API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-clear-cache)\n\nClear the cache"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Clone API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-clone)\n\nClone an index"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Close API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-close)\n\nClose an index"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Create API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-create)\n\nCreate an index"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Create Data Stream API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-create-data-stream)\n\nCreate a data stream"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Create From API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-create-from)\n\nCreate an index from a source index"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Data Streams Stats API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-data-streams-stats-1)\n\nGet data stream stats"]
#[derive(Clone, Debug)]
...
impl<'a, 'b> IndicesDataStreamsStats<'a, 'b> {
    ...
    #[doc = "Whether to expand wildcard expressions to concrete data stream names that are open, closed or both."]
    pub fn expand_wildcards(mut self, expand_wildcards: &'b [&'b str]) -> Self {
        self.expand_wildcards = Some(expand_wildcards);
        self
    }
...
#[doc = "Builder for the [Indices Delete API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-delete)\n\nDelete indices"]
#[derive(Clone, Debug)]
...
impl<'a, 'b> IndicesDelete<'a, 'b> {
    ...
    #[doc = "Whether wildcard expressions should get expanded to open, closed, or hidden indices"]
    pub fn expand_wildcards(mut self, expand_wildcards: &'b [&'b str]) -> Self {
        self.expand_wildcards = Some(expand_wildcards);
        self
    }
...
#[doc = "Builder for the [Indices Delete Alias API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-delete-alias)\n\nDelete an alias"]
#[derive(Clone, Debug)]
...
impl<'b> IndicesDeleteDataLifecycleParts<'b> {
    ...
    pub fn url(self) -> Cow<'static, str> {
        match self {
            IndicesDeleteDataLifecycleParts::Name(name) => {
                let name_str = name.join(",");
                let encoded_name: Cow<str> =
                    percent_encode(name_str.as_bytes(), PARTS_ENCODED).into();
                ...
                p.push_str("/_data_stream/");
                p.push_str(encoded_name.as_ref());
                p.push_str("/_lifecycle");
                p.into()
            }
        }
    }
}
#[doc = "Builder for the [Indices Delete Data Lifecycle API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-delete-data-lifecycle)\n\nDelete data stream lifecycles"]
#[derive(Clone, Debug)]
...
impl<'a, 'b> IndicesDeleteDataLifecycle<'a, 'b> {
    ...
    #[doc = "Creates an asynchronous call to the Indices Delete Data Lifecycle API that can be awaited"]
    pub async fn send(self) -> Result<Response, Error> {
        let path = self.parts.url();
        let method = http::Method::Delete;
        let headers = self.headers;
...
#[doc = "Builder for the [Indices Delete Data Stream API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-delete-data-stream)\n\nDelete data streams"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Delete Data Stream Options API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-delete-data-stream-options)\n\nDelete data stream options"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Delete Index Template API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-delete-index-template)\n\nDelete an index template"]
#[derive(Clone, Debug)]
...
#[derive(Debug, Clone, PartialEq, Eq)]
#[doc = "API parts for the Indices Delete Sample Configuration API"]
pub enum IndicesDeleteSampleConfigurationParts<'b> {
    #[doc = "Index"]
    Index(&'b str),
}
#[cfg(feature = "experimental-apis")]
impl<'b> IndicesDeleteSampleConfigurationParts<'b> {
    #[doc = "Builds a relative URL path to the Indices Delete Sample Configuration API"]
    pub fn url(self) -> Cow<'static, str> {
        match self {
            IndicesDeleteSampleConfigurationParts::Index(index) => {
                let encoded_index: Cow<str> =
                    percent_encode(index.as_bytes(), PARTS_ENCODED).into();
                let mut p = String::with_capacity(16usize + encoded_index.len());
                p.push('/');
                p.push_str(encoded_index.as_ref());
                p.push_str("/_sample/config");
                p.into()
            }
        }
    }
}
#[doc = "Builder for the [Indices Delete Sample Configuration API](https://www.elastic.co/docs/api/doc/elasticsearch#TODO)\n\nDelete sampling configuration for an index or data stream"]
#[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
#[cfg(feature = "experimental-apis")]
#[derive(Clone, Debug)]
pub struct IndicesDeleteSampleConfiguration<'a, 'b> {
    transport: &'a Transport,
    parts: IndicesDeleteSampleConfigurationParts<'b>,
    error_trace: Option<bool>,
    filter_path: Option<&'b [&'b str]>,
    headers: HeaderMap,
    human: Option<bool>,
...
#[cfg(feature = "experimental-apis")]
impl<'a, 'b> IndicesDeleteSampleConfiguration<'a, 'b> {
    #[doc = "Creates a new instance of [IndicesDeleteSampleConfiguration] with the specified API parts"]
    pub fn new(transport: &'a Transport, parts: IndicesDeleteSampleConfigurationParts<'b>) -> Self {
        let headers = HeaderMap::new();
        IndicesDeleteSampleConfiguration {
            transport,
            parts,
            headers,
            error_trace: None,
    ...
    #[doc = "Creates an asynchronous call to the Indices Delete Sample Configuration API that can be awaited"]
    pub async fn send(self) -> Result<Response, Error> {
        let path = self.parts.url();
        let method = http::Method::Delete;
        let headers = self.headers;
...
#[doc = "Builder for the [Indices Delete Template API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-delete-template)\n\nDelete a legacy index template"]
#[derive(Clone, Debug)]
...
impl<'b> IndicesDiskUsageParts<'b> {
    ...
    pub fn url(self) -> Cow<'static, str> {
        match self {
            IndicesDiskUsageParts::Index(index) => {
                let index_str = index.join(",");
                let encoded_index: Cow<str> =
                    percent_encode(index_str.as_bytes(), PARTS_ENCODED).into();
...
#[doc = "Builder for the [Indices Disk Usage API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-disk-usage)\n\nAnalyze the index disk usage"]
#[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
#[cfg(feature = "experimental-apis")]
#[derive(Clone, Debug)]
...
impl<'b> IndicesDownsampleParts<'b> {
    ...
    pub fn url(self) -> Cow<'static, str> {
        match self {
            IndicesDownsampleParts::IndexTargetIndex(index, target_index) => {
                let encoded_index: Cow<str> =
                    percent_encode(index.as_bytes(), PARTS_ENCODED).into();
...
#[doc = "Builder for the [Indices Downsample API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-downsample)\n\nDownsample an index"]
#[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
#[cfg(feature = "experimental-apis")]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Exists API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-exists)\n\nCheck indices"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Exists Alias API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-exists-alias)\n\nCheck aliases"]
#[derive(Clone, Debug)]
...
impl<'a, 'b> IndicesExistsAlias<'a, 'b> {
    ...
    #[doc = "Timeout for waiting for new cluster state in case it is blocked"]
    pub fn master_timeout(mut self, master_timeout: &'b str) -> Self {
        self.master_timeout = Some(master_timeout);
        self
    }
...
#[doc = "Builder for the [Indices Exists Index Template API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-exists-index-template)\n\nCheck index templates"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Exists Template API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-exists-template)\n\nCheck existence of index templates"]
#[derive(Clone, Debug)]
...
impl<'b> IndicesExplainDataLifecycleParts<'b> {
    ...
    pub fn url(self) -> Cow<'static, str> {
        match self {
            IndicesExplainDataLifecycleParts::Index(index) => {
                let index_str = index.join(",");
                let encoded_index: Cow<str> =
                    percent_encode(index_str.as_bytes(), PARTS_ENCODED).into();
                ...
                p.push('/');
                p.push_str(encoded_index.as_ref());
                p.push_str("/_lifecycle/explain");
                p.into()
            }
        }
    }
}
#[doc = "Builder for the [Indices Explain Data Lifecycle API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-explain-data-lifecycle)\n\nGet the status for a data stream lifecycle"]
#[derive(Clone, Debug)]
...
impl<'a, 'b> IndicesExplainDataLifecycle<'a, 'b> {
    ...
    #[doc = "indicates if the API should return the default values the system uses for the index's lifecycle"]
    pub fn include_defaults(mut self, include_defaults: bool) -> Self {
        self.include_defaults = Some(include_defaults);
        self
    }
    ...
    #[doc = "Creates an asynchronous call to the Indices Explain Data Lifecycle API that can be awaited"]
    pub async fn send(self) -> Result<Response, Error> {
        let path = self.parts.url();
        let method = http::Method::Get;
        let headers = self.headers;
...
impl<'b> IndicesFieldUsageStatsParts<'b> {
    ...
    pub fn url(self) -> Cow<'static, str> {
        match self {
            IndicesFieldUsageStatsParts::Index(index) => {
                let index_str = index.join(",");
                let encoded_index: Cow<str> =
                    percent_encode(index_str.as_bytes(), PARTS_ENCODED).into();
                let mut p = String::with_capacity(20usize + encoded_index.len());
...
#[doc = "Builder for the [Indices Field Usage Stats API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-field-usage-stats)\n\nGet field usage stats"]
#[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
#[cfg(feature = "experimental-apis")]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Flush API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-flush)\n\nFlush data streams or indices"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Forcemerge API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-forcemerge)\n\nForce a merge"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Get API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-get)\n\nGet index information"]
#[derive(Clone, Debug)]
...
impl<'a, 'b> IndicesGet<'a, 'b> {
    ...
    pub fn features(mut self, features: &'b [&'b str]) -> Self {
...
#[doc = "Builder for the [Indices Get Alias API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-get-alias)\n\nGet aliases"]
#[derive(Clone, Debug)]
...
#[cfg(feature = "experimental-apis")]
#[derive(Debug, Clone, PartialEq, Eq)]
#[doc = "API parts for the Indices Get All Sample Configuration API"]
pub enum IndicesGetAllSampleConfigurationParts {
    #[doc = "No parts"]
    None,
}
#[cfg(feature = "experimental-apis")]
impl IndicesGetAllSampleConfigurationParts {
    #[doc = "Builds a relative URL path to the Indices Get All Sample Configuration API"]
    pub fn url(self) -> Cow<'static, str> {
        match self {
            IndicesGetAllSampleConfigurationParts::None => "/_sample/config".into(),
        }
    }
}
#[doc = "Builder for the [Indices Get All Sample Configuration API](https://www.elastic.co/docs/api/doc/elasticsearch#TODO)\n\nGet sampling configurations for all indices and data streams"]
#[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
#[cfg(feature = "experimental-apis")]
#[derive(Clone, Debug)]
pub struct IndicesGetAllSampleConfiguration<'a, 'b> {
    transport: &'a Transport,
    parts: IndicesGetAllSampleConfigurationParts,
    error_trace: Option<bool>,
    filter_path: Option<&'b [&'b str]>,
    headers: HeaderMap,
    human: Option<bool>,
...
#[cfg(feature = "experimental-apis")]
impl<'a, 'b> IndicesGetAllSampleConfiguration<'a, 'b> {
    #[doc = "Creates a new instance of [IndicesGetAllSampleConfiguration]"]
    pub fn new(transport: &'a Transport) -> Self {
        let headers = HeaderMap::new();
        IndicesGetAllSampleConfiguration {
            transport,
            parts: IndicesGetAllSampleConfigurationParts::None,
            headers,
            error_trace: None,
            filter_path: None,
            human: None,
    ...
    #[doc = "Creates an asynchronous call to the Indices Get All Sample Configuration API that can be awaited"]
    pub async fn send(self) -> Result<Response, Error> {
        let path = self.parts.url();
        let method = http::Method::Get;
        let headers = self.headers;
...
impl<'b> IndicesGetDataLifecycleParts<'b> {
    ...
    pub fn url(self) -> Cow<'static, str> {
        match self {
            IndicesGetDataLifecycleParts::Name(name) => {
                let name_str = name.join(",");
                let encoded_name: Cow<str> =
                    percent_encode(name_str.as_bytes(), PARTS_ENCODED).into();
                let mut p = String::with_capacity(25usize + encoded_name.len());
...
#[doc = "Builder for the [Indices Get Data Lifecycle API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-get-data-lifecycle)\n\nGet data stream lifecycles"]
#[derive(Clone, Debug)]
...
impl<'a, 'b> IndicesGetDataLifecycle<'a, 'b> {
    ...
    #[doc = "Return all relevant default configurations for the data stream (default: false)"]
    pub fn include_defaults(mut self, include_defaults: bool) -> Self {
        self.include_defaults = Some(include_defaults);
        self
    }
    ...
    #[doc = "Creates an asynchronous call to the Indices Get Data Lifecycle API that can be awaited"]
    pub async fn send(self) -> Result<Response, Error> {
        let path = self.parts.url();
        let method = http::Method::Get;
        let headers = self.headers;
...
#[doc = "Builder for the [Indices Get Data Lifecycle Stats API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-get-data-lifecycle-stats)\n\nGet data stream lifecycle stats"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Get Data Stream API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-get-data-stream)\n\nGet data streams"]
#[derive(Clone, Debug)]
...
#[derive(Debug, Clone, PartialEq, Eq)]
#[doc = "API parts for the Indices Get Data Stream Mappings API"]
pub enum IndicesGetDataStreamMappingsParts<'b> {
    #[doc = "Name"]
    Name(&'b [&'b str]),
}
impl<'b> IndicesGetDataStreamMappingsParts<'b> {
    #[doc = "Builds a relative URL path to the Indices Get Data Stream Mappings API"]
    pub fn url(self) -> Cow<'static, str> {
        match self {
            IndicesGetDataStreamMappingsParts::Name(name) => {
                let name_str = name.join(",");
                let encoded_name: Cow<str> =
                    percent_encode(name_str.as_bytes(), PARTS_ENCODED).into();
...
#[doc = "Builder for the [Indices Get Data Stream Mappings API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-get-data-stream-mappings)\n\nGet data stream mappings"]
#[derive(Clone, Debug)]
pub struct IndicesGetDataStreamMappings<'a, 'b> {
    transport: &'a Transport,
    parts: IndicesGetDataStreamMappingsParts<'b>,
    error_trace: Option<bool>,
    filter_path: Option<&'b [&'b str]>,
    headers: HeaderMap,
    human: Option<bool>,
...
impl<'a, 'b> IndicesGetDataStreamMappings<'a, 'b> {
    #[doc = "Creates a new instance of [IndicesGetDataStreamMappings] with the specified API parts"]
    pub fn new(transport: &'a Transport, parts: IndicesGetDataStreamMappingsParts<'b>) -> Self {
        let headers = HeaderMap::new();
        IndicesGetDataStreamMappings {
            transport,
            parts,
            headers,
            error_trace: None,
    ...
    #[doc = "Creates an asynchronous call to the Indices Get Data Stream Mappings API that can be awaited"]
    pub async fn send(self) -> Result<Response, Error> {
        let path = self.parts.url();
        let method = http::Method::Get;
        let headers = self.headers;
...
#[doc = "Builder for the [Indices Get Data Stream Options API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-get-data-stream-options)\n\nGet data stream options"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Get Data Stream Settings API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-get-data-stream-settings)\n\nGet data stream settings"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Get Field Mapping API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-get-mapping)\n\nGet mapping definitions"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Get Index Template API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-get-index-template)\n\nGet index templates"]
#[derive(Clone, Debug)]
...
impl<'a, 'b> IndicesGetIndexTemplate<'a, 'b> {
    ...
    #[doc = "Return all relevant default configurations for the index template (default: false)"]
    pub fn include_defaults(mut self, include_defaults: bool) -> Self {
        self.include_defaults = Some(include_defaults);
        self
    }
...
#[doc = "Builder for the [Indices Get Mapping API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-get-mapping)\n\nGet mapping definitions"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Get Migrate Reindex Status API](https://www.elastic.co/docs/api/doc/elasticsearch/group/endpoint-migration)\n\nGet the migration reindexing status"]
#[derive(Clone, Debug)]
...
#[cfg(feature = "experimental-apis")]
#[derive(Debug, Clone, PartialEq, Eq)]
#[doc = "API parts for the Indices Get Sample API"]
pub enum IndicesGetSampleParts<'b> {
    #[doc = "Index"]
    Index(&'b str),
}
#[cfg(feature = "experimental-apis")]
impl<'b> IndicesGetSampleParts<'b> {
    #[doc = "Builds a relative URL path to the Indices Get Sample API"]
    pub fn url(self) -> Cow<'static, str> {
        match self {
            IndicesGetSampleParts::Index(index) => {
                let encoded_index: Cow<str> =
                    percent_encode(index.as_bytes(), PARTS_ENCODED).into();
...
#[doc = "Builder for the [Indices Get Sample API](https://www.elastic.co/docs/api/doc/elasticsearch#TODO)\n\nGet random sample of ingested data"]
#[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
#[cfg(feature = "experimental-apis")]
#[derive(Clone, Debug)]
pub struct IndicesGetSample<'a, 'b> {
    transport: &'a Transport,
    parts: IndicesGetSampleParts<'b>,
    error_trace: Option<bool>,
    filter_path: Option<&'b [&'b str]>,
    headers: HeaderMap,
    human: Option<bool>,
...
#[cfg(feature = "experimental-apis")]
impl<'a, 'b> IndicesGetSample<'a, 'b> {
    #[doc = "Creates a new instance of [IndicesGetSample] with the specified API parts"]
    pub fn new(transport: &'a Transport, parts: IndicesGetSampleParts<'b>) -> Self {
        let headers = HeaderMap::new();
        IndicesGetSample {
            transport,
            parts,
    ...
    #[doc = "Creates an asynchronous call to the Indices Get Sample API that can be awaited"]
    pub async fn send(self) -> Result<Response, Error> {
        let path = self.parts.url();
        let method = http::Method::Get;
        let headers = self.headers;
...
#[cfg(feature = "experimental-apis")]
#[derive(Debug, Clone, PartialEq, Eq)]
#[doc = "API parts for the Indices Get Sample Configuration API"]
pub enum IndicesGetSampleConfigurationParts<'b> {
    #[doc = "Index"]
    Index(&'b str),
}
#[cfg(feature = "experimental-apis")]
impl<'b> IndicesGetSampleConfigurationParts<'b> {
    #[doc = "Builds a relative URL path to the Indices Get Sample Configuration API"]
    pub fn url(self) -> Cow<'static, str> {
        match self {
            IndicesGetSampleConfigurationParts::Index(index) => {
                let encoded_index: Cow<str> =
                    percent_encode(index.as_bytes(), PARTS_ENCODED).into();
                let mut p = String::with_capacity(16usize + encoded_index.len());
                p.push('/');
...
#[doc = "Builder for the [Indices Get Sample Configuration API](https://www.elastic.co/docs/api/doc/elasticsearch#TODO)\n\nGet sampling configuration for an index or data stream"]
#[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
#[cfg(feature = "experimental-apis")]
#[derive(Clone, Debug)]
pub struct IndicesGetSampleConfiguration<'a, 'b> {
    transport: &'a Transport,
    parts: IndicesGetSampleConfigurationParts<'b>,
    error_trace: Option<bool>,
    filter_path: Option<&'b [&'b str]>,
    headers: HeaderMap,
    human: Option<bool>,
...
#[cfg(feature = "experimental-apis")]
impl<'a, 'b> IndicesGetSampleConfiguration<'a, 'b> {
    #[doc = "Creates a new instance of [IndicesGetSampleConfiguration] with the specified API parts"]
    pub fn new(transport: &'a Transport, parts: IndicesGetSampleConfigurationParts<'b>) -> Self {
        let headers = HeaderMap::new();
    ...
    #[doc = "Creates an asynchronous call to the Indices Get Sample Configuration API that can be awaited"]
    pub async fn send(self) -> Result<Response, Error> {
        let path = self.parts.url();
        let method = http::Method::Get;
        let headers = self.headers;
...
#[cfg(feature = "experimental-apis")]
#[derive(Debug, Clone, PartialEq, Eq)]
#[doc = "API parts for the Indices Get Sample Stats API"]
pub enum IndicesGetSampleStatsParts<'b> {
    #[doc = "Index"]
    Index(&'b str),
}
#[cfg(feature = "experimental-apis")]
impl<'b> IndicesGetSampleStatsParts<'b> {
    #[doc = "Builds a relative URL path to the Indices Get Sample Stats API"]
    pub fn url(self) -> Cow<'static, str> {
        match self {
            IndicesGetSampleStatsParts::Index(index) => {
                let encoded_index: Cow<str> =
                    percent_encode(index.as_bytes(), PARTS_ENCODED).into();
                let mut p = String::with_capacity(15usize + encoded_index.len());
                p.push('/');
                p.push_str(encoded_index.as_ref());
                p.push_str("/_sample/stats");
                p.into()
            }
        }
    }
}
#[doc = "Builder for the [Indices Get Sample Stats API](https://www.elastic.co/docs/api/doc/elasticsearch#TODO)\n\nGet stats about a random sample of ingested data"]
#[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
#[cfg(feature = "experimental-apis")]
#[derive(Clone, Debug)]
pub struct IndicesGetSampleStats<'a, 'b> {
    transport: &'a Transport,
    parts: IndicesGetSampleStatsParts<'b>,
    error_trace: Option<bool>,
    filter_path: Option<&'b [&'b str]>,
    headers: HeaderMap,
    human: Option<bool>,
...
#[cfg(feature = "experimental-apis")]
impl<'a, 'b> IndicesGetSampleStats<'a, 'b> {
    #[doc = "Creates a new instance of [IndicesGetSampleStats] with the specified API parts"]
    pub fn new(transport: &'a Transport, parts: IndicesGetSampleStatsParts<'b>) -> Self {
        let headers = HeaderMap::new();
        IndicesGetSampleStats {
            transport,
            parts,
            headers,
            error_trace: None,
    ...
    #[doc = "Creates an asynchronous call to the Indices Get Sample Stats API that can be awaited"]
    pub async fn send(self) -> Result<Response, Error> {
        let path = self.parts.url();
        let method = http::Method::Get;
        let headers = self.headers;
...
#[doc = "Builder for the [Indices Get Settings API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-get-settings)\n\nGet index settings"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Get Template API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-get-template)\n\nGet legacy index templates"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Migrate Reindex API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-migrate-reindex)\n\nReindex legacy backing indices"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Migrate To Data Stream API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-migrate-to-data-stream)\n\nConvert an index alias to a data stream"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Modify Data Stream API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-modify-data-stream)\n\nUpdate data streams"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Open API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-open)\n\nOpen a closed index"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Promote Data Stream API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-promote-data-stream)\n\nPromote a data stream"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Put Alias API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-put-alias)\n\nCreate or update an alias"]
#[derive(Clone, Debug)]
...
impl<'b> IndicesPutDataLifecycleParts<'b> {
    ...
    pub fn url(self) -> Cow<'static, str> {
        match self {
            IndicesPutDataLifecycleParts::Name(name) => {
                let name_str = name.join(",");
                let encoded_name: Cow<str> =
                    percent_encode(name_str.as_bytes(), PARTS_ENCODED).into();
                let mut p = String::with_capacity(25usize + encoded_name.len());
...
#[doc = "Builder for the [Indices Put Data Lifecycle API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-put-data-lifecycle)\n\nUpdate data stream lifecycles"]
#[derive(Clone, Debug)]
...
where
    B: Body,
{
    #[doc = "Creates a new instance of [IndicesPutDataLifecycle] with the specified API parts"]
    pub fn new(transport: &'a Transport, parts: IndicesPutDataLifecycleParts<'b>) -> Self {
        let headers = HeaderMap::new();
    ...
    #[doc = "The body for the API call"]
    pub fn body<T>(self, body: T) -> IndicesPutDataLifecycle<'a, 'b, JsonBody<T>>
    where
        T: Serialize,
    {
        IndicesPutDataLifecycle {
    ...
    #[doc = "Creates an asynchronous call to the Indices Put Data Lifecycle API that can be awaited"]
    pub async fn send(self) -> Result<Response, Error> {
        let path = self.parts.url();
        let method = http::Method::Put;
        let headers = self.headers;
...
#[derive(Debug, Clone, PartialEq, Eq)]
#[doc = "API parts for the Indices Put Data Stream Mappings API"]
pub enum IndicesPutDataStreamMappingsParts<'b> {
    #[doc = "Name"]
    Name(&'b [&'b str]),
}
impl<'b> IndicesPutDataStreamMappingsParts<'b> {
    #[doc = "Builds a relative URL path to the Indices Put Data Stream Mappings API"]
    pub fn url(self) -> Cow<'static, str> {
        match self {
            IndicesPutDataStreamMappingsParts::Name(name) => {
                let name_str = name.join(",");
                let encoded_name: Cow<str> =
                    percent_encode(name_str.as_bytes(), PARTS_ENCODED).into();
                let mut p = String::with_capacity(24usize + encoded_name.len());
...
#[doc = "Builder for the [Indices Put Data Stream Mappings API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-put-data-stream-mappings)\n\nUpdate data stream mappings"]
#[derive(Clone, Debug)]
pub struct IndicesPutDataStreamMappings<'a, 'b, B> {
    transport: &'a Transport,
    parts: IndicesPutDataStreamMappingsParts<'b>,
    body: Option<B>,
    dry_run: Option<bool>,
    error_trace: Option<bool>,
    filter_path: Option<&'b [&'b str]>,
...
impl<'a, 'b, B> IndicesPutDataStreamMappings<'a, 'b, B>
where
    B: Body,
{
    #[doc = "Creates a new instance of [IndicesPutDataStreamMappings] with the specified API parts"]
    pub fn new(transport: &'a Transport, parts: IndicesPutDataStreamMappingsParts<'b>) -> Self {
        let headers = HeaderMap::new();
        IndicesPutDataStreamMappings {
            transport,
            parts,
            headers,
            body: None,
    ...
    #[doc = "The body for the API call"]
    pub fn body<T>(self, body: T) -> IndicesPutDataStreamMappings<'a, 'b, JsonBody<T>>
    where
        T: Serialize,
    {
        IndicesPutDataStreamMappings {
    ...
    #[doc = "Whether this request should only be a dry run rather than actually applying mappings"]
    ...
    #[doc = "Creates an asynchronous call to the Indices Put Data Stream Mappings API that can be awaited"]
    pub async fn send(self) -> Result<Response, Error> {
        let path = self.parts.url();
        let method = http::Method::Put;
        let headers = self.headers;
...
#[doc = "Builder for the [Indices Put Data Stream Options API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-put-data-stream-options)\n\nUpdate data stream options"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Put Data Stream Settings API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-put-data-stream-settings)\n\nUpdate data stream settings"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Put Index Template API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-put-index-template)\n\nCreate or update an index template"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Put Mapping API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-put-mapping)\n\nUpdate field mappings"]
#[derive(Clone, Debug)]
...
#[cfg(feature = "experimental-apis")]
#[derive(Debug, Clone, PartialEq, Eq)]
#[doc = "API parts for the Indices Put Sample Configuration API"]
pub enum IndicesPutSampleConfigurationParts<'b> {
    #[doc = "Index"]
    Index(&'b str),
}
#[cfg(feature = "experimental-apis")]
impl<'b> IndicesPutSampleConfigurationParts<'b> {
    #[doc = "Builds a relative URL path to the Indices Put Sample Configuration API"]
    pub fn url(self) -> Cow<'static, str> {
        match self {
            IndicesPutSampleConfigurationParts::Index(index) => {
                let encoded_index: Cow<str> =
                    percent_encode(index.as_bytes(), PARTS_ENCODED).into();
                let mut p = String::with_capacity(16usize + encoded_index.len());
                p.push('/');
...
#[doc = "Builder for the [Indices Put Sample Configuration API](https://www.elastic.co/docs/api/doc/elasticsearch#TODO)\n\nConfigure sampling for an index or data stream"]
#[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
#[cfg(feature = "experimental-apis")]
#[derive(Clone, Debug)]
pub struct IndicesPutSampleConfiguration<'a, 'b, B> {
    transport: &'a Transport,
    parts: IndicesPutSampleConfigurationParts<'b>,
    body: Option<B>,
    error_trace: Option<bool>,
    filter_path: Option<&'b [&'b str]>,
    headers: HeaderMap,
...
#[cfg(feature = "experimental-apis")]
impl<'a, 'b, B> IndicesPutSampleConfiguration<'a, 'b, B>
where
    B: Body,
{
    #[doc = "Creates a new instance of [IndicesPutSampleConfiguration] with the specified API parts"]
    pub fn new(transport: &'a Transport, parts: IndicesPutSampleConfigurationParts<'b>) -> Self {
        let headers = HeaderMap::new();
        IndicesPutSampleConfiguration {
            transport,
            parts,
            headers,
            body: None,
    ...
    #[doc = "The body for the API call"]
    pub fn body<T>(self, body: T) -> IndicesPutSampleConfiguration<'a, 'b, JsonBody<T>>
    where
        T: Serialize,
    {
        IndicesPutSampleConfiguration {
    ...
    #[doc = "Creates an asynchronous call to the Indices Put Sample Configuration API that can be awaited"]
    pub async fn send(self) -> Result<Response, Error> {
        let path = self.parts.url();
        let method = http::Method::Put;
        let headers = self.headers;
...
#[doc = "Builder for the [Indices Put Settings API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-put-settings)\n\nUpdate index settings"]
#[derive(Clone, Debug)]
    ...
    B: Body,
{
    ...
    #[doc = "Whether to close and reopen the index to apply non-dynamic settings. If set to `true` the indices to which the settings are being applied will be closed temporarily and then reopened in order to apply the changes. The default is `false`"]
...
#[doc = "Builder for the [Indices Put Template API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-put-template)\n\nCreate or update a legacy index template"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Recovery API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-recovery)\n\nGet index recovery information"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Refresh API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-refresh)\n\nRefresh an index"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Reload Search Analyzers API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-reload-search-analyzers)\n\nReload search analyzers"]
#[derive(Clone, Debug)]
    ...
    B: Body,
{
    ...
    #[doc = "changed resource to reload analyzers from if applicable"]
    pub fn resource(mut self, resource: &'b str) -> Self {
...
#[derive(Debug, Clone, PartialEq, Eq)]
#[doc = "API parts for the Indices Remove Block API"]
pub enum IndicesRemoveBlockParts<'b> {
    #[doc = "Index and Block"]
    IndexBlock(&'b [&'b str], Block),
}
impl<'b> IndicesRemoveBlockParts<'b> {
    #[doc = "Builds a relative URL path to the Indices Remove Block API"]
    pub fn url(self) -> Cow<'static, str> {
        match self {
            IndicesRemoveBlockParts::IndexBlock(index, block) => {
                let index_str = index.join(",");
                let block_str = block.to_string();
                let encoded_index: Cow<str> =
                    percent_encode(index_str.as_bytes(), PARTS_ENCODED).into();
...
#[doc = "Builder for the [Indices Remove Block API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-remove-block)\n\nRemove an index block"]
#[derive(Clone, Debug)]
pub struct IndicesRemoveBlock<'a, 'b> {
    transport: &'a Transport,
    parts: IndicesRemoveBlockParts<'b>,
    allow_no_indices: Option<bool>,
    error_trace: Option<bool>,
    expand_wildcards: Option<&'b [&'b str]>,
    filter_path: Option<&'b [&'b str]>,
...
impl<'a, 'b> IndicesRemoveBlock<'a, 'b> {
    #[doc = "Creates a new instance of [IndicesRemoveBlock] with the specified API parts"]
    pub fn new(transport: &'a Transport, parts: IndicesRemoveBlockParts<'b>) -> Self {
        let headers = HeaderMap::new();
        IndicesRemoveBlock {
            transport,
            parts,
    ...
    #[doc = "Creates an asynchronous call to the Indices Remove Block API that can be awaited"]
    pub async fn send(self) -> Result<Response, Error> {
        let path = self.parts.url();
        let method = http::Method::Delete;
        let headers = self.headers;
...
impl<'b> IndicesResolveClusterParts<'b> {
...
#[doc = "Builder for the [Indices Resolve Cluster API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-resolve-cluster)\n\nResolve the cluster"]
#[derive(Clone, Debug)]
...
impl<'a, 'b> IndicesResolveCluster<'a, 'b> {
    ...
    pub fn new(transport: &'a Transport, parts: IndicesResolveClusterParts<'b>) -> Self {
        let headers = HeaderMap::new();
        IndicesResolveCluster {
            transport,
            parts,
            headers,
            allow_no_indices: None,
...
#[doc = "Builder for the [Indices Resolve Index API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-resolve-index)\n\nResolve indices"]
#[derive(Clone, Debug)]
...
impl<'a, 'b> IndicesResolveIndex<'a, 'b> {
    ...
    #[doc = "Filter indices by index mode. Comma-separated list of IndexMode. Empty means no filter."]
    pub fn mode(mut self, mode: &'b [&'b str]) -> Self {
        self.mode = Some(mode);
        self
    }
    #[doc = "Pretty format the returned JSON response."]
    ...
    #[doc = "A Lucene query using project metadata tags to limit which projects to search, such as _alias:_origin or _alias:*pr*. Only supported in serverless."]
    pub fn project_routing(mut self, project_routing: &'b str) -> Self {
        self.project_routing = Some(project_routing);
        self
    }
    #[doc = "Sets a request timeout for this API call.\n\nThe timeout is applied from when the request starts connecting until the response body has finished."]
    pub fn request_timeout(mut self, timeout: Duration) -> Self {
...
#[doc = "Builder for the [Indices Rollover API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-rollover)\n\nRoll over to a new index"]
#[derive(Clone, Debug)]
    ...
    B: Body,
{
    ...
    #[doc = "If set to true, the rollover action will only mark a data stream to signal that it needs to be rolled over at the next write. Only allowed on data streams."]
...
#[doc = "Builder for the [Indices Segments API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-segments)\n\nGet index segments"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Shard Stores API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-shard-stores)\n\nGet index shard stores"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Shrink API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-shrink)\n\nShrink an index"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Simulate Index Template API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-simulate-index-template)\n\nSimulate an index"]
#[derive(Clone, Debug)]
    ...
    B: Body,
{
    ...
    #[doc = "Return all relevant default configurations for this index template simulation (default: false)"]
    pub fn include_defaults(mut self, include_defaults: bool) -> Self {
        self.include_defaults = Some(include_defaults);
        self
    }
...
#[doc = "Builder for the [Indices Simulate Template API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-simulate-template)\n\nSimulate an index template"]
#[derive(Clone, Debug)]
    ...
    B: Body,
{
    ...
    #[doc = "Return all relevant default configurations for this template simulation (default: false)"]
    pub fn include_defaults(mut self, include_defaults: bool) -> Self {
        self.include_defaults = Some(include_defaults);
        self
    }
...
#[doc = "Builder for the [Indices Split API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-split)\n\nSplit an index"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Stats API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-stats)\n\nGet index statistics"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Update Aliases API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-update-aliases)\n\nCreate or update an alias"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Validate Query API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-validate-query)\n\nValidate a query"]
#[derive(Clone, Debug)]
...
impl<'a> Indices<'a> {
    ...
    #[doc = "[Indices Add Block API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-add-block)\n\nAdd an index block"]
    pub fn add_block<'b>(&'a self, parts: IndicesAddBlockParts<'b>) -> IndicesAddBlock<'a, 'b, ()> {
        IndicesAddBlock::new(self.transport(), parts)
    }
    #[doc = "[Indices Analyze API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-analyze)\n\nGet tokens from text analysis"]
    pub fn analyze<'b>(&'a self, parts: IndicesAnalyzeParts<'b>) -> IndicesAnalyze<'a, 'b, ()> {
        IndicesAnalyze::new(self.transport(), parts)
    }
    #[doc = "[Indices Cancel Migrate Reindex API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-cancel-migrate-reindex)\n\nCancel a migration reindex operation"]
    ...
    #[doc = "[Indices Clear Cache API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-clear-cache)\n\nClear the cache"]
    ...
    #[doc = "[Indices Create From API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-create-from)\n\nCreate an index from a source index"]
    ...
    #[doc = "[Indices Data Streams Stats API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-data-streams-stats-1)\n\nGet data stream stats"]
    ...
    #[doc = "[Indices Delete API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-delete)\n\nDelete indices"]
    pub fn delete<'b>(&'a self, parts: IndicesDeleteParts<'b>) -> IndicesDelete<'a, 'b> {
        IndicesDelete::new(self.transport(), parts)
    }
    #[doc = "[Indices Delete Alias API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-delete-alias)\n\nDelete an alias"]
    ...
    #[doc = "[Indices Delete Data Lifecycle API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-delete-data-lifecycle)\n\nDelete data stream lifecycles"]
    ...
    #[doc = "[Indices Delete Data Stream API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-delete-data-stream)\n\nDelete data streams"]
    ...
    #[doc = "[Indices Delete Data Stream Options API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-delete-data-stream-options)\n\nDelete data stream options"]
    ...
    #[doc = "[Indices Delete Index Template API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-delete-index-template)\n\nDelete an index template"]
    ...
    #[doc = "[Indices Delete Sample Configuration API](https://www.elastic.co/docs/api/doc/elasticsearch#TODO)\n\nDelete sampling configuration for an index or data stream"]
    #[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
    #[cfg(feature = "experimental-apis")]
    pub fn delete_sample_configuration<'b>(
        &'a self,
        parts: IndicesDeleteSampleConfigurationParts<'b>,
    ) -> IndicesDeleteSampleConfiguration<'a, 'b> {
        IndicesDeleteSampleConfiguration::new(self.transport(), parts)
    }
    #[doc = "[Indices Delete Template API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-delete-template)\n\nDelete a legacy index template"]
    ...
    #[doc = "[Indices Disk Usage API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-disk-usage)\n\nAnalyze the index disk usage"]
    #[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
    #[cfg(feature = "experimental-apis")]
    pub fn disk_usage<'b>(
        &'a self,
    ...
    #[doc = "[Indices Downsample API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-downsample)\n\nDownsample an index"]
    #[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
    #[cfg(feature = "experimental-apis")]
    pub fn downsample<'b>(
        &'a self,
    ...
    #[doc = "[Indices Exists API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-exists)\n\nCheck indices"]
    pub fn exists<'b>(&'a self, parts: IndicesExistsParts<'b>) -> IndicesExists<'a, 'b> {
        IndicesExists::new(self.transport(), parts)
    }
    #[doc = "[Indices Exists Alias API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-exists-alias)\n\nCheck aliases"]
    ...
    #[doc = "[Indices Exists Index Template API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-exists-index-template)\n\nCheck index templates"]
    ...
    #[doc = "[Indices Exists Template API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-exists-template)\n\nCheck existence of index templates"]
    ...
    #[doc = "[Indices Explain Data Lifecycle API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-explain-data-lifecycle)\n\nGet the status for a data stream lifecycle"]
    ...
    #[doc = "[Indices Field Usage Stats API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-field-usage-stats)\n\nGet field usage stats"]
    #[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
    #[cfg(feature = "experimental-apis")]
    ...
    #[doc = "[Indices Flush API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-flush)\n\nFlush data streams or indices"]
    pub fn flush<'b>(&'a self, parts: IndicesFlushParts<'b>) -> IndicesFlush<'a, 'b, ()> {
        IndicesFlush::new(self.transport(), parts)
    }
    #[doc = "[Indices Forcemerge API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-forcemerge)\n\nForce a merge"]
    pub fn forcemerge<'b>(
        &'a self,
        parts: IndicesForcemergeParts<'b>,
    ...
    #[doc = "[Indices Get API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-get)\n\nGet index information"]
    pub fn get<'b>(&'a self, parts: IndicesGetParts<'b>) -> IndicesGet<'a, 'b> {
        IndicesGet::new(self.transport(), parts)
    }
    #[doc = "[Indices Get Alias API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-get-alias)\n\nGet aliases"]
    pub fn get_alias<'b>(&'a self, parts: IndicesGetAliasParts<'b>) -> IndicesGetAlias<'a, 'b> {
        IndicesGetAlias::new(self.transport(), parts)
    }
    #[doc = "[Indices Get All Sample Configuration API](https://www.elastic.co/docs/api/doc/elasticsearch#TODO)\n\nGet sampling configurations for all indices and data streams"]
    #[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
    #[cfg(feature = "experimental-apis")]
    pub fn get_all_sample_configuration<'b>(&'a self) -> IndicesGetAllSampleConfiguration<'a, 'b> {
        IndicesGetAllSampleConfiguration::new(self.transport())
    }
    #[doc = "[Indices Get Data Lifecycle API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-get-data-lifecycle)\n\nGet data stream lifecycles"]
    ...
    #[doc = "[Indices Get Data Lifecycle Stats API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-get-data-lifecycle-stats)\n\nGet data stream lifecycle stats"]
    pub fn get_data_lifecycle_stats<'b>(&'a self) -> IndicesGetDataLifecycleStats<'a, 'b> {
        IndicesGetDataLifecycleStats::new(self.transport())
    }
    #[doc = "[Indices Get Data Stream API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-get-data-stream)\n\nGet data streams"]
    ...
    #[doc = "[Indices Get Data Stream Mappings API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-get-data-stream-mappings)\n\nGet data stream mappings"]
    pub fn get_data_stream_mappings<'b>(
        &'a self,
        parts: IndicesGetDataStreamMappingsParts<'b>,
    ) -> IndicesGetDataStreamMappings<'a, 'b> {
        IndicesGetDataStreamMappings::new(self.transport(), parts)
    }
    #[doc = "[Indices Get Data Stream Options API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-get-data-stream-options)\n\nGet data stream options"]
    ...
    #[doc = "[Indices Get Data Stream Settings API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-get-data-stream-settings)\n\nGet data stream settings"]
    ...
    #[doc = "[Indices Get Field Mapping API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-get-mapping)\n\nGet mapping definitions"]
    ...
    #[doc = "[Indices Get Index Template API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-get-index-template)\n\nGet index templates"]
    ...
    #[doc = "[Indices Get Mapping API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-get-mapping)\n\nGet mapping definitions"]
    ...
    #[doc = "[Indices Get Migrate Reindex Status API](https://www.elastic.co/docs/api/doc/elasticsearch/group/endpoint-migration)\n\nGet the migration reindexing status"]
    ...
    #[doc = "[Indices Get Sample API](https://www.elastic.co/docs/api/doc/elasticsearch#TODO)\n\nGet random sample of ingested data"]
    #[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
    #[cfg(feature = "experimental-apis")]
    pub fn get_sample<'b>(&'a self, parts: IndicesGetSampleParts<'b>) -> IndicesGetSample<'a, 'b> {
        IndicesGetSample::new(self.transport(), parts)
    }
    #[doc = "[Indices Get Sample Configuration API](https://www.elastic.co/docs/api/doc/elasticsearch#TODO)\n\nGet sampling configuration for an index or data stream"]
    #[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
    #[cfg(feature = "experimental-apis")]
    pub fn get_sample_configuration<'b>(
        &'a self,
        parts: IndicesGetSampleConfigurationParts<'b>,
    ) -> IndicesGetSampleConfiguration<'a, 'b> {
        IndicesGetSampleConfiguration::new(self.transport(), parts)
    }
    #[doc = "[Indices Get Sample Stats API](https://www.elastic.co/docs/api/doc/elasticsearch#TODO)\n\nGet stats about a random sample of ingested data"]
    #[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
    #[cfg(feature = "experimental-apis")]
    pub fn get_sample_stats<'b>(
        &'a self,
        parts: IndicesGetSampleStatsParts<'b>,
    ) -> IndicesGetSampleStats<'a, 'b> {
        IndicesGetSampleStats::new(self.transport(), parts)
    }
    #[doc = "[Indices Get Settings API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-get-settings)\n\nGet index settings"]
    ...
    #[doc = "[Indices Get Template API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-get-template)\n\nGet legacy index templates"]
    ...
    #[doc = "[Indices Migrate Reindex API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-migrate-reindex)\n\nReindex legacy backing indices"]
    pub fn migrate_reindex<'b>(&'a self) -> IndicesMigrateReindex<'a, 'b, ()> {
        IndicesMigrateReindex::new(self.transport())
    }
    #[doc = "[Indices Migrate To Data Stream API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-migrate-to-data-stream)\n\nConvert an index alias to a data stream"]
    ...
    #[doc = "[Indices Modify Data Stream API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-modify-data-stream)\n\nUpdate data streams"]
    pub fn modify_data_stream<'b>(&'a self) -> IndicesModifyDataStream<'a, 'b, ()> {
        IndicesModifyDataStream::new(self.transport())
    }
    #[doc = "[Indices Open API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-open)\n\nOpen a closed index"]
    pub fn open<'b>(&'a self, parts: IndicesOpenParts<'b>) -> IndicesOpen<'a, 'b, ()> {
        IndicesOpen::new(self.transport(), parts)
    }
    #[doc = "[Indices Promote Data Stream API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-promote-data-stream)\n\nPromote a data stream"]
    ...
    #[doc = "[Indices Put Alias API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-put-alias)\n\nCreate or update an alias"]
    pub fn put_alias<'b>(&'a self, parts: IndicesPutAliasParts<'b>) -> IndicesPutAlias<'a, 'b, ()> {
        IndicesPutAlias::new(self.transport(), parts)
    }
    #[doc = "[Indices Put Data Lifecycle API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-put-data-lifecycle)\n\nUpdate data stream lifecycles"]
    ...
    #[doc = "[Indices Put Data Stream Mappings API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-put-data-stream-mappings)\n\nUpdate data stream mappings"]
    pub fn put_data_stream_mappings<'b>(
        &'a self,
        parts: IndicesPutDataStreamMappingsParts<'b>,
    ) -> IndicesPutDataStreamMappings<'a, 'b, ()> {
        IndicesPutDataStreamMappings::new(self.transport(), parts)
    }
    #[doc = "[Indices Put Data Stream Options API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-put-data-stream-options)\n\nUpdate data stream options"]
    ...
    #[doc = "[Indices Put Data Stream Settings API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-put-data-stream-settings)\n\nUpdate data stream settings"]
    ...
    #[doc = "[Indices Put Index Template API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-put-index-template)\n\nCreate or update an index template"]
    ...
    #[doc = "[Indices Put Sample Configuration API](https://www.elastic.co/docs/api/doc/elasticsearch#TODO)\n\nConfigure sampling for an index or data stream"]
    #[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
    #[cfg(feature = "experimental-apis")]
    pub fn put_sample_configuration<'b>(
        &'a self,
        parts: IndicesPutSampleConfigurationParts<'b>,
    ) -> IndicesPutSampleConfiguration<'a, 'b, ()> {
        IndicesPutSampleConfiguration::new(self.transport(), parts)
    }
    #[doc = "[Indices Put Settings API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-put-settings)\n\nUpdate index settings"]
    ...
    #[doc = "[Indices Put Template API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-put-template)\n\nCreate or update a legacy index template"]
    ...
    #[doc = "[Indices Recovery API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-recovery)\n\nGet index recovery information"]
    pub fn recovery<'b>(&'a self, parts: IndicesRecoveryParts<'b>) -> IndicesRecovery<'a, 'b> {
        IndicesRecovery::new(self.transport(), parts)
    }
    #[doc = "[Indices Refresh API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-refresh)\n\nRefresh an index"]
    pub fn refresh<'b>(&'a self, parts: IndicesRefreshParts<'b>) -> IndicesRefresh<'a, 'b, ()> {
        IndicesRefresh::new(self.transport(), parts)
    }
    #[doc = "[Indices Reload Search Analyzers API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-reload-search-analyzers)\n\nReload search analyzers"]
    ...
    #[doc = "[Indices Remove Block API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-remove-block)\n\nRemove an index block"]
    pub fn remove_block<'b>(
        &'a self,
        parts: IndicesRemoveBlockParts<'b>,
    ) -> IndicesRemoveBlock<'a, 'b> {
        IndicesRemoveBlock::new(self.transport(), parts)
    }
    #[doc = "[Indices Resolve Cluster API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-resolve-cluster)\n\nResolve the cluster"]
    ...
    #[doc = "[Indices Resolve Index API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-resolve-index)\n\nResolve indices"]
    ...
    #[doc = "[Indices Rollover API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-rollover)\n\nRoll over to a new index"]
    pub fn rollover<'b>(&'a self, parts: IndicesRolloverParts<'b>) -> IndicesRollover<'a, 'b, ()> {
        IndicesRollover::new(self.transport(), parts)
    }
    #[doc = "[Indices Segments API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-segments)\n\nGet index segments"]
    pub fn segments<'b>(&'a self, parts: IndicesSegmentsParts<'b>) -> IndicesSegments<'a, 'b> {
        IndicesSegments::new(self.transport(), parts)
    }
    #[doc = "[Indices Shard Stores API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-shard-stores)\n\nGet index shard stores"]
    ...
    #[doc = "[Indices Shrink API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-shrink)\n\nShrink an index"]
    pub fn shrink<'b>(&'a self, parts: IndicesShrinkParts<'b>) -> IndicesShrink<'a, 'b, ()> {
        IndicesShrink::new(self.transport(), parts)
    }
    #[doc = "[Indices Simulate Index Template API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-simulate-index-template)\n\nSimulate an index"]
    ...
    #[doc = "[Indices Simulate Template API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-simulate-template)\n\nSimulate an index template"]
    ...
    #[doc = "[Indices Split API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-split)\n\nSplit an index"]
    pub fn split<'b>(&'a self, parts: IndicesSplitParts<'b>) -> IndicesSplit<'a, 'b, ()> {
        IndicesSplit::new(self.transport(), parts)
    }
    #[doc = "[Indices Stats API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-stats)\n\nGet index statistics"]
    pub fn stats<'b>(&'a self, parts: IndicesStatsParts<'b>) -> IndicesStats<'a, 'b> {
        IndicesStats::new(self.transport(), parts)
    }
    #[doc = "[Indices Update Aliases API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-update-aliases)\n\nCreate or update an alias"]
    pub fn update_aliases<'b>(&'a self) -> IndicesUpdateAliases<'a, 'b, ()> {
        IndicesUpdateAliases::new(self.transport())
    }
    #[doc = "[Indices Validate Query API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-validate-query)\n\nValidate a query"]
