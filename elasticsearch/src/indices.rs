    ...
    B: Body,
{
    ...
    #[doc = "Whether to allow (1) wildcard index expressions that match no indices and (2) requests where the final resolved set is empty."]
...
impl<'a, 'b> IndicesGetIndexTemplate<'a, 'b> {
    ...
    #[doc = "Include internally managed fields (default: false)"]
    pub fn include_managed_fields(mut self, include_managed_fields: bool) -> Self {
        self.include_managed_fields = Some(include_managed_fields);
        self
    }
    #[doc = "Return local information, do not retrieve the state from master node (default: false)"]
    pub fn local(mut self, local: bool) -> Self {
...
impl<'a, 'b> IndicesResolveCluster<'a, 'b> {
    ...
    #[doc = "Whether to allow (1) wildcard index expressions that match no indices and (2) requests where the final resolved set is empty. Only allowed when providing an index expression."]
    pub fn allow_no_indices(mut self, allow_no_indices: bool) -> Self {
        self.allow_no_indices = Some(allow_no_indices);
        self
    }
