...
#[doc = "Builder for the [Indices Add Block API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/index-modules-blocks.html)\n\nAdds a block to an index."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Analyze API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-analyze.html)\n\nPerforms the analysis process on a text and return the tokens breakdown of the text."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Cancel Migrate Reindex API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/data-stream-reindex-cancel-api.html)\n\nThis API returns the status of a migration reindex attempt for a data stream or index"]
...
#[doc = "Builder for the [Indices Clear Cache API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-clearcache.html)\n\nClears all or specific caches for one or more indices."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Clone API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-clone-index.html)\n\nClones an index"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Close API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-open-close.html)\n\nCloses an index."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Create API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-create-index.html)\n\nCreates an index with optional settings and mappings."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Create Data Stream API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/data-streams.html)\n\nCreates a data stream"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Data Streams Stats API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/data-streams.html)\n\nProvides statistics on operations happening in a data stream."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Delete API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-delete-index.html)\n\nDeletes an index."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Delete Alias API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-aliases.html)\n\nDeletes an alias."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Delete Data Lifecycle API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/data-streams-delete-lifecycle.html)\n\nDeletes the data stream lifecycle of the selected data streams."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Delete Data Stream API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/data-streams.html)\n\nDeletes a data stream."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Delete Index Template API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-delete-template.html)\n\nDeletes an index template."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Delete Template API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-delete-template-v1.html)\n\nDeletes an index template."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Disk Usage API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-disk-usage.html)\n\nAnalyzes the disk usage of each field of an index or data stream"]
#[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
#[cfg(feature = "experimental-apis")]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Downsample API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/xpack-rollup.html)\n\nDownsample an index"]
#[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
#[cfg(feature = "experimental-apis")]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Exists API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-exists.html)\n\nReturns information about whether a particular index exists."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Exists Alias API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-aliases.html)\n\nReturns information about whether a particular alias exists."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Exists Index Template API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/index-templates.html)\n\nReturns information about whether a particular index template exists."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Exists Template API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-template-exists-v1.html)\n\nReturns information about whether a particular index template exists."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Explain Data Lifecycle API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/data-streams-explain-lifecycle.html)\n\nRetrieves information about the index's current data stream lifecycle, such as any potential encountered error, time since creation etc."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Field Usage Stats API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/field-usage-stats.html)\n\nReturns the field usage stats for each field of an index"]
#[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
#[cfg(feature = "experimental-apis")]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Flush API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-flush.html)\n\nPerforms the flush operation on one or more indices."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Forcemerge API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-forcemerge.html)\n\nPerforms the force merge operation on one or more indices."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Get API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-get-index.html)\n\nReturns information about one or more indices."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Get Alias API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-aliases.html)\n\nReturns an alias."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Get Data Lifecycle API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/data-streams-get-lifecycle.html)\n\nReturns the data stream lifecycle of the selected data streams."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Get Data Lifecycle Stats API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/data-streams-get-lifecycle-stats.html)\n\nGet data stream lifecycle statistics."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Get Data Stream API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/data-streams.html)\n\nReturns data streams."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Get Field Mapping API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-get-field-mapping.html)\n\nReturns mapping for one or more fields."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Get Index Template API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-get-template.html)\n\nReturns an index template."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Get Mapping API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-get-mapping.html)\n\nReturns mappings for one or more indices."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Get Migrate Reindex Status API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/data-stream-reindex-status-api.html)\n\nThis API returns the status of a migration reindex attempt for a data stream or index"]
#[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
#[cfg(feature = "experimental-apis")]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Get Settings API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-get-settings.html)\n\nReturns settings for one or more indices."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Get Template API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-get-template-v1.html)\n\nReturns an index template."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Migrate To Data Stream API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/data-streams.html)\n\nMigrates an alias to a data stream"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Modify Data Stream API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/data-streams.html)\n\nModifies a data stream"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Open API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-open-close.html)\n\nOpens an index."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Promote Data Stream API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/data-streams.html)\n\nPromotes a data stream from a replicated data stream managed by CCR to a regular data stream"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Put Alias API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-aliases.html)\n\nCreates or updates an alias."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Put Data Lifecycle API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/data-streams-put-lifecycle.html)\n\nUpdates the data stream lifecycle of the selected data streams."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Put Index Template API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-put-template.html)\n\nCreates or updates an index template."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Put Mapping API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-put-mapping.html)\n\nUpdates the index mappings."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Put Settings API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-update-settings.html)\n\nUpdates the index settings."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Put Template API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-templates-v1.html)\n\nCreates or updates an index template."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Recovery API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-recovery.html)\n\nReturns information about ongoing index shard recoveries."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Refresh API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-refresh.html)\n\nPerforms the refresh operation in one or more indices."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Reload Search Analyzers API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-reload-analyzers.html)\n\nReloads an index's search analyzers and their resources."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Resolve Index API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-resolve-index-api.html)\n\nReturns information about any matching indices, aliases, and data streams"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Rollover API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-rollover-index.html)\n\nUpdates an alias to point to a new index when the existing index\nis considered to be too large or too old."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Segments API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-segments.html)\n\nProvides low-level information about segments in a Lucene index."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Shard Stores API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-shards-stores.html)\n\nProvides store information for shard copies of indices."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Shrink API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-shrink-index.html)\n\nAllow to shrink an existing index into a new index with fewer primary shards."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Simulate Index Template API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-simulate-index.html)\n\nSimulate matching the given index name against the index templates in the system"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Simulate Template API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-simulate-template.html)\n\nSimulate resolving the given template name or body"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Split API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-split-index.html)\n\nAllows you to split an existing index into a new index with more primary shards."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Stats API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-stats.html)\n\nProvides statistics on operations happening in an index."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Update Aliases API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-aliases.html)\n\nUpdates index aliases."]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Indices Validate Query API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/search-validate.html)\n\nAllows a user to validate a potentially expensive query without executing it."]
#[derive(Clone, Debug)]
...
impl<'a> Indices<'a> {
    ...
    #[doc = "[Indices Add Block API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/index-modules-blocks.html)\n\nAdds a block to an index."]
    pub fn add_block<'b>(&'a self, parts: IndicesAddBlockParts<'b>) -> IndicesAddBlock<'a, 'b, ()> {
        IndicesAddBlock::new(self.transport(), parts)
    }
    #[doc = "[Indices Analyze API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-analyze.html)\n\nPerforms the analysis process on a text and return the tokens breakdown of the text."]
    pub fn analyze<'b>(&'a self, parts: IndicesAnalyzeParts<'b>) -> IndicesAnalyze<'a, 'b, ()> {
        IndicesAnalyze::new(self.transport(), parts)
    }
    #[doc = "[Indices Cancel Migrate Reindex API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/data-stream-reindex-cancel-api.html)\n\nThis API returns the status of a migration reindex attempt for a data stream or index"]
    #[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
    #[cfg(feature = "experimental-apis")]
    ...
    #[doc = "[Indices Clear Cache API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-clearcache.html)\n\nClears all or specific caches for one or more indices."]
    ...
    #[doc = "[Indices Create From API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-create-index-from-source.html)\n\nThis API creates a destination from a source index. It copies the mappings and settings from the source index while allowing request settings and mappings to override the source values."]
    #[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
    #[cfg(feature = "experimental-apis")]
    ...
    #[doc = "[Indices Data Streams Stats API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/data-streams.html)\n\nProvides statistics on operations happening in a data stream."]
    ...
    #[doc = "[Indices Delete API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-delete-index.html)\n\nDeletes an index."]
    pub fn delete<'b>(&'a self, parts: IndicesDeleteParts<'b>) -> IndicesDelete<'a, 'b> {
        IndicesDelete::new(self.transport(), parts)
    }
    #[doc = "[Indices Delete Alias API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-aliases.html)\n\nDeletes an alias."]
    ...
    #[doc = "[Indices Delete Data Lifecycle API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/data-streams-delete-lifecycle.html)\n\nDeletes the data stream lifecycle of the selected data streams."]
    ...
    #[doc = "[Indices Delete Data Stream API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/data-streams.html)\n\nDeletes a data stream."]
    ...
    #[doc = "[Indices Delete Index Template API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-delete-template.html)\n\nDeletes an index template."]
    ...
    #[doc = "[Indices Delete Template API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-delete-template-v1.html)\n\nDeletes an index template."]
    ...
    #[doc = "[Indices Disk Usage API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-disk-usage.html)\n\nAnalyzes the disk usage of each field of an index or data stream"]
    #[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
    #[cfg(feature = "experimental-apis")]
    pub fn disk_usage<'b>(
        &'a self,
    ...
    #[doc = "[Indices Downsample API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/xpack-rollup.html)\n\nDownsample an index"]
    #[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
    #[cfg(feature = "experimental-apis")]
    pub fn downsample<'b>(
        &'a self,
    ...
    #[doc = "[Indices Exists API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-exists.html)\n\nReturns information about whether a particular index exists."]
    pub fn exists<'b>(&'a self, parts: IndicesExistsParts<'b>) -> IndicesExists<'a, 'b> {
        IndicesExists::new(self.transport(), parts)
    }
    #[doc = "[Indices Exists Alias API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-aliases.html)\n\nReturns information about whether a particular alias exists."]
    ...
    #[doc = "[Indices Exists Index Template API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/index-templates.html)\n\nReturns information about whether a particular index template exists."]
    ...
    #[doc = "[Indices Exists Template API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-template-exists-v1.html)\n\nReturns information about whether a particular index template exists."]
    ...
    #[doc = "[Indices Explain Data Lifecycle API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/data-streams-explain-lifecycle.html)\n\nRetrieves information about the index's current data stream lifecycle, such as any potential encountered error, time since creation etc."]
    ...
    #[doc = "[Indices Field Usage Stats API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/field-usage-stats.html)\n\nReturns the field usage stats for each field of an index"]
    #[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
    #[cfg(feature = "experimental-apis")]
    ...
    #[doc = "[Indices Flush API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-flush.html)\n\nPerforms the flush operation on one or more indices."]
    pub fn flush<'b>(&'a self, parts: IndicesFlushParts<'b>) -> IndicesFlush<'a, 'b, ()> {
        IndicesFlush::new(self.transport(), parts)
    }
    #[doc = "[Indices Forcemerge API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-forcemerge.html)\n\nPerforms the force merge operation on one or more indices."]
    pub fn forcemerge<'b>(
        &'a self,
        parts: IndicesForcemergeParts<'b>,
    ...
    #[doc = "[Indices Get API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-get-index.html)\n\nReturns information about one or more indices."]
    pub fn get<'b>(&'a self, parts: IndicesGetParts<'b>) -> IndicesGet<'a, 'b> {
        IndicesGet::new(self.transport(), parts)
    }
    #[doc = "[Indices Get Alias API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-aliases.html)\n\nReturns an alias."]
    pub fn get_alias<'b>(&'a self, parts: IndicesGetAliasParts<'b>) -> IndicesGetAlias<'a, 'b> {
        IndicesGetAlias::new(self.transport(), parts)
    }
    #[doc = "[Indices Get Data Lifecycle API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/data-streams-get-lifecycle.html)\n\nReturns the data stream lifecycle of the selected data streams."]
    ...
    #[doc = "[Indices Get Data Lifecycle Stats API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/data-streams-get-lifecycle-stats.html)\n\nGet data stream lifecycle statistics."]
    pub fn get_data_lifecycle_stats<'b>(&'a self) -> IndicesGetDataLifecycleStats<'a, 'b> {
        IndicesGetDataLifecycleStats::new(self.transport())
    }
    #[doc = "[Indices Get Data Stream API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/data-streams.html)\n\nReturns data streams."]
    ...
    #[doc = "[Indices Get Field Mapping API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-get-field-mapping.html)\n\nReturns mapping for one or more fields."]
    ...
    #[doc = "[Indices Get Index Template API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-get-template.html)\n\nReturns an index template."]
    ...
    #[doc = "[Indices Get Mapping API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-get-mapping.html)\n\nReturns mappings for one or more indices."]
    ...
    #[doc = "[Indices Get Migrate Reindex Status API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/data-stream-reindex-status-api.html)\n\nThis API returns the status of a migration reindex attempt for a data stream or index"]
    #[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
    #[cfg(feature = "experimental-apis")]
    ...
    #[doc = "[Indices Get Settings API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-get-settings.html)\n\nReturns settings for one or more indices."]
    ...
    #[doc = "[Indices Get Template API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-get-template-v1.html)\n\nReturns an index template."]
    ...
    #[doc = "[Indices Migrate Reindex API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/data-stream-reindex-api.html)\n\nThis API reindexes all legacy backing indices for a data stream. It does this in a persistent task. The persistent task id is returned immediately, and the reindexing work is completed in that task"]
    #[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
    #[cfg(feature = "experimental-apis")]
    pub fn migrate_reindex<'b>(&'a self) -> IndicesMigrateReindex<'a, 'b, ()> {
        IndicesMigrateReindex::new(self.transport())
    }
    #[doc = "[Indices Migrate To Data Stream API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/data-streams.html)\n\nMigrates an alias to a data stream"]
    ...
    #[doc = "[Indices Modify Data Stream API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/data-streams.html)\n\nModifies a data stream"]
    pub fn modify_data_stream<'b>(&'a self) -> IndicesModifyDataStream<'a, 'b, ()> {
        IndicesModifyDataStream::new(self.transport())
    }
    #[doc = "[Indices Open API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-open-close.html)\n\nOpens an index."]
    pub fn open<'b>(&'a self, parts: IndicesOpenParts<'b>) -> IndicesOpen<'a, 'b, ()> {
        IndicesOpen::new(self.transport(), parts)
    }
    #[doc = "[Indices Promote Data Stream API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/data-streams.html)\n\nPromotes a data stream from a replicated data stream managed by CCR to a regular data stream"]
    ...
    #[doc = "[Indices Put Alias API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-aliases.html)\n\nCreates or updates an alias."]
    pub fn put_alias<'b>(&'a self, parts: IndicesPutAliasParts<'b>) -> IndicesPutAlias<'a, 'b, ()> {
        IndicesPutAlias::new(self.transport(), parts)
    }
    #[doc = "[Indices Put Data Lifecycle API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/data-streams-put-lifecycle.html)\n\nUpdates the data stream lifecycle of the selected data streams."]
    ...
    #[doc = "[Indices Put Index Template API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-put-template.html)\n\nCreates or updates an index template."]
    ...
    #[doc = "[Indices Put Settings API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-update-settings.html)\n\nUpdates the index settings."]
    ...
    #[doc = "[Indices Put Template API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-templates-v1.html)\n\nCreates or updates an index template."]
    ...
    #[doc = "[Indices Recovery API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-recovery.html)\n\nReturns information about ongoing index shard recoveries."]
    pub fn recovery<'b>(&'a self, parts: IndicesRecoveryParts<'b>) -> IndicesRecovery<'a, 'b> {
        IndicesRecovery::new(self.transport(), parts)
    }
    #[doc = "[Indices Refresh API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-refresh.html)\n\nPerforms the refresh operation in one or more indices."]
    pub fn refresh<'b>(&'a self, parts: IndicesRefreshParts<'b>) -> IndicesRefresh<'a, 'b, ()> {
        IndicesRefresh::new(self.transport(), parts)
    }
    #[doc = "[Indices Reload Search Analyzers API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-reload-analyzers.html)\n\nReloads an index's search analyzers and their resources."]
    ...
    #[doc = "[Indices Resolve Cluster API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-resolve-cluster-api.html)\n\nResolves the specified index expressions to return information about each cluster. If no index expression is provided, this endpoint will return information about all the remote clusters that are configured on the local cluster."]
    ...
    #[doc = "[Indices Resolve Index API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-resolve-index-api.html)\n\nReturns information about any matching indices, aliases, and data streams"]
    ...
    #[doc = "[Indices Rollover API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-rollover-index.html)\n\nUpdates an alias to point to a new index when the existing index\nis considered to be too large or too old."]
    pub fn rollover<'b>(&'a self, parts: IndicesRolloverParts<'b>) -> IndicesRollover<'a, 'b, ()> {
        IndicesRollover::new(self.transport(), parts)
    }
    #[doc = "[Indices Segments API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-segments.html)\n\nProvides low-level information about segments in a Lucene index."]
    pub fn segments<'b>(&'a self, parts: IndicesSegmentsParts<'b>) -> IndicesSegments<'a, 'b> {
        IndicesSegments::new(self.transport(), parts)
    }
    #[doc = "[Indices Shard Stores API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-shards-stores.html)\n\nProvides store information for shard copies of indices."]
    ...
    #[doc = "[Indices Shrink API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-shrink-index.html)\n\nAllow to shrink an existing index into a new index with fewer primary shards."]
    pub fn shrink<'b>(&'a self, parts: IndicesShrinkParts<'b>) -> IndicesShrink<'a, 'b, ()> {
        IndicesShrink::new(self.transport(), parts)
    }
    #[doc = "[Indices Simulate Index Template API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-simulate-index.html)\n\nSimulate matching the given index name against the index templates in the system"]
    ...
    #[doc = "[Indices Simulate Template API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-simulate-template.html)\n\nSimulate resolving the given template name or body"]
    ...
    #[doc = "[Indices Split API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-split-index.html)\n\nAllows you to split an existing index into a new index with more primary shards."]
    pub fn split<'b>(&'a self, parts: IndicesSplitParts<'b>) -> IndicesSplit<'a, 'b, ()> {
        IndicesSplit::new(self.transport(), parts)
    }
    #[doc = "[Indices Stats API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-stats.html)\n\nProvides statistics on operations happening in an index."]
    pub fn stats<'b>(&'a self, parts: IndicesStatsParts<'b>) -> IndicesStats<'a, 'b> {
        IndicesStats::new(self.transport(), parts)
    }
    #[doc = "[Indices Unfreeze API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/unfreeze-index-api.html)\n\nUnfreezes an index. When a frozen index is unfrozen, the index goes through the normal recovery process and becomes writeable again."]
    pub fn unfreeze<'b>(&'a self, parts: IndicesUnfreezeParts<'b>) -> IndicesUnfreeze<'a, 'b, ()> {
        IndicesUnfreeze::new(self.transport(), parts)
    }
    #[doc = "[Indices Update Aliases API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/indices-aliases.html)\n\nUpdates index aliases."]
    pub fn update_aliases<'b>(&'a self) -> IndicesUpdateAliases<'a, 'b, ()> {
        IndicesUpdateAliases::new(self.transport())
    }
    #[doc = "[Indices Validate Query API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/search-validate.html)\n\nAllows a user to validate a potentially expensive query without executing it."]
