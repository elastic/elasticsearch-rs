...
#[doc = "Builder for the [Synonyms Get Synonyms Sets API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-synonyms-set.html)\n\nGet all synonym sets"]
#[derive(Clone, Debug)]
...
impl<'a> Synonyms<'a> {
    ...
    #[doc = "[Synonyms Get Synonyms Sets API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-synonyms-set.html)\n\nGet all synonym sets"]
