...
#[doc = "Builder for the [Monitoring Bulk API](https://www.elastic.co/docs/api/doc/elasticsearch/v8)\n\nSend monitoring data"]
#[derive(Clone, Debug)]
...
impl<'a> Monitoring<'a> {
    ...
    #[doc = "[Monitoring Bulk API](https://www.elastic.co/docs/api/doc/elasticsearch/v8)\n\nSend monitoring data"]
