...
#[doc = "Behavioral analytics event type. Available: page_view, search, search_click"]
...
impl ::std::fmt::Display for EventType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match *self {
            ...
            EventType::SearchClick => write!(f, "search_click"),
        }
    }
}
...
impl ::std::fmt::Display for Format {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match *self {
            ...
            Format::Delimited => write!(f, "delimited"),
            Format::SemiStructuredText => write!(f, "semi_structured_text"),
        }
    }
}
...
impl ::std::fmt::Display for Sort {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match *self {
            Sort::StartTime => write!(f, "start_time"),
            Sort::Duration => write!(f, "duration"),
            Sort::Name => write!(f, "name"),
            Sort::Repository => write!(f, "repository"),
            Sort::IndexCount => write!(f, "index_count"),
            Sort::ShardCount => write!(f, "shard_count"),
            Sort::FailedShardCount => write!(f, "failed_shard_count"),
        }
    }
}
