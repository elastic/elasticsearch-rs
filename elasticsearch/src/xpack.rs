...
#[doc = "Builder for the [Xpack Info API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/info-api.html)\n\nRetrieves information about the installed X-Pack features."]
#[derive(Clone, Debug)]
...
impl<'a, 'b> XpackInfo<'a, 'b> {
    ...
    #[doc = "Defines whether additional human-readable information is included in the response. In particular, it adds descriptions and a tag line. The default value is true."]
...
#[doc = "Builder for the [Xpack Usage API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/usage-api.html)\n\nRetrieves usage information about the installed X-Pack features."]
#[derive(Clone, Debug)]
...
impl<'a> Xpack<'a> {
    ...
    #[doc = "[Xpack Info API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/info-api.html)\n\nRetrieves information about the installed X-Pack features."]
    pub fn info<'b>(&'a self) -> XpackInfo<'a, 'b> {
        XpackInfo::new(self.transport())
    }
    #[doc = "[Xpack Usage API](https://www.elastic.co/guide/en/elasticsearch/reference/8.18/usage-api.html)\n\nRetrieves usage information about the installed X-Pack features."]
