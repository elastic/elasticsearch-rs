...
#[doc = "Builder for the [Xpack Usage API](https://www.elastic.co/docs/api/doc/elasticsearch/v8/group/endpoint-xpack)\n\nGet usage information"]
#[derive(Clone, Debug)]
...
impl<'a> Xpack<'a> {
    ...
    #[doc = "[Xpack Usage API](https://www.elastic.co/docs/api/doc/elasticsearch/v8/group/endpoint-xpack)\n\nGet usage information"]
