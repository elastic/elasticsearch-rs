...
#[doc = "Builder for the [Nodes Clear Repositories Metering Archive API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-nodes-clear-repositories-metering-archive)\n\nClear the archived repositories metering"]
...
#[doc = "Builder for the [Nodes Get Repositories Metering Info API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-nodes-get-repositories-metering-info)\n\nGet cluster repositories metering"]
#[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
#[cfg(feature = "experimental-apis")]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Nodes Hot Threads API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-nodes-hot-threads)\n\nGet the hot threads for nodes"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Nodes Info API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-nodes-info)\n\nGet node information"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Nodes Reload Secure Settings API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-nodes-reload-secure-settings)\n\nReload the keystore on nodes in the cluster"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Nodes Stats API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-nodes-stats)\n\nGet node statistics"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Nodes Usage API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-nodes-usage)\n\nGet feature usage information"]
#[derive(Clone, Debug)]
...
impl<'a> Nodes<'a> {
    ...
    #[doc = "[Nodes Clear Repositories Metering Archive API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-nodes-clear-repositories-metering-archive)\n\nClear the archived repositories metering"]
    #[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
    #[cfg(feature = "experimental-apis")]
    ...
    #[doc = "[Nodes Get Repositories Metering Info API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-nodes-get-repositories-metering-info)\n\nGet cluster repositories metering"]
    #[doc = "&nbsp;\n# Optional, experimental\nThis requires the `experimental-apis` feature. Can have breaking changes in future\nversions or might even be removed entirely.\n        "]
    #[cfg(feature = "experimental-apis")]
    ...
    #[doc = "[Nodes Hot Threads API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-nodes-hot-threads)\n\nGet the hot threads for nodes"]
    pub fn hot_threads<'b>(&'a self, parts: NodesHotThreadsParts<'b>) -> NodesHotThreads<'a, 'b> {
        NodesHotThreads::new(self.transport(), parts)
    }
    #[doc = "[Nodes Info API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-nodes-info)\n\nGet node information"]
    pub fn info<'b>(&'a self, parts: NodesInfoParts<'b>) -> NodesInfo<'a, 'b> {
        NodesInfo::new(self.transport(), parts)
    }
    #[doc = "[Nodes Reload Secure Settings API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-nodes-reload-secure-settings)\n\nReload the keystore on nodes in the cluster"]
    ...
    #[doc = "[Nodes Stats API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-nodes-stats)\n\nGet node statistics"]
    pub fn stats<'b>(&'a self, parts: NodesStatsParts<'b>) -> NodesStats<'a, 'b> {
        NodesStats::new(self.transport(), parts)
    }
    #[doc = "[Nodes Usage API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-nodes-usage)\n\nGet feature usage information"]
