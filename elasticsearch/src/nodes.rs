...
#[doc = "Builder for the [Nodes Reload Secure Settings API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cluster-nodes-reload-secure-settings.html)\n\nReload the keystore on nodes in the cluster"]
#[derive(Clone, Debug)]
...
impl<'a> Nodes<'a> {
    ...
    #[doc = "[Nodes Reload Secure Settings API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cluster-nodes-reload-secure-settings.html)\n\nReload the keystore on nodes in the cluster"]
