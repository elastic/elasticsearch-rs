...
#[doc = "Builder for the [Watcher Ack Watch API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-watcher-ack-watch)\n\nAcknowledge a watch"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Watcher Activate Watch API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-watcher-activate-watch)\n\nActivate a watch"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Watcher Deactivate Watch API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-watcher-deactivate-watch)\n\nDeactivate a watch"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Watcher Delete Watch API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-watcher-delete-watch)\n\nDelete a watch"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Watcher Execute Watch API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-watcher-execute-watch)\n\nRun a watch"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Watcher Get Settings API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-watcher-get-settings)\n\nGet Watcher index settings"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Watcher Get Watch API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-watcher-get-watch)\n\nGet a watch"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Watcher Put Watch API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-watcher-put-watch)\n\nCreate or update a watch"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Watcher Query Watches API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-watcher-query-watches)\n\nQuery watches"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Watcher Start API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-watcher-start)\n\nStart the watch service"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Watcher Stats API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-watcher-stats)\n\nGet Watcher statistics"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Watcher Stop API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-watcher-stop)\n\nStop the watch service"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Watcher Update Settings API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-watcher-update-settings)\n\nUpdate Watcher index settings"]
#[derive(Clone, Debug)]
...
impl<'a> Watcher<'a> {
    ...
    #[doc = "[Watcher Ack Watch API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-watcher-ack-watch)\n\nAcknowledge a watch"]
    pub fn ack_watch<'b>(&'a self, parts: WatcherAckWatchParts<'b>) -> WatcherAckWatch<'a, 'b, ()> {
        WatcherAckWatch::new(self.transport(), parts)
    }
    #[doc = "[Watcher Activate Watch API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-watcher-activate-watch)\n\nActivate a watch"]
    ...
    #[doc = "[Watcher Deactivate Watch API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-watcher-deactivate-watch)\n\nDeactivate a watch"]
    ...
    #[doc = "[Watcher Delete Watch API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-watcher-delete-watch)\n\nDelete a watch"]
    ...
    #[doc = "[Watcher Execute Watch API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-watcher-execute-watch)\n\nRun a watch"]
    ...
    #[doc = "[Watcher Get Settings API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-watcher-get-settings)\n\nGet Watcher index settings"]
    pub fn get_settings<'b>(&'a self) -> WatcherGetSettings<'a, 'b> {
        WatcherGetSettings::new(self.transport())
    }
    #[doc = "[Watcher Get Watch API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-watcher-get-watch)\n\nGet a watch"]
    pub fn get_watch<'b>(&'a self, parts: WatcherGetWatchParts<'b>) -> WatcherGetWatch<'a, 'b> {
        WatcherGetWatch::new(self.transport(), parts)
    }
    #[doc = "[Watcher Put Watch API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-watcher-put-watch)\n\nCreate or update a watch"]
    pub fn put_watch<'b>(&'a self, parts: WatcherPutWatchParts<'b>) -> WatcherPutWatch<'a, 'b, ()> {
        WatcherPutWatch::new(self.transport(), parts)
    }
    #[doc = "[Watcher Query Watches API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-watcher-query-watches)\n\nQuery watches"]
    pub fn query_watches<'b>(&'a self) -> WatcherQueryWatches<'a, 'b, ()> {
        WatcherQueryWatches::new(self.transport())
    }
    #[doc = "[Watcher Start API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-watcher-start)\n\nStart the watch service"]
    pub fn start<'b>(&'a self) -> WatcherStart<'a, 'b, ()> {
        WatcherStart::new(self.transport())
    }
    #[doc = "[Watcher Stats API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-watcher-stats)\n\nGet Watcher statistics"]
    pub fn stats<'b>(&'a self, parts: WatcherStatsParts<'b>) -> WatcherStats<'a, 'b> {
        WatcherStats::new(self.transport(), parts)
    }
    #[doc = "[Watcher Stop API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-watcher-stop)\n\nStop the watch service"]
    pub fn stop<'b>(&'a self) -> WatcherStop<'a, 'b, ()> {
        WatcherStop::new(self.transport())
    }
    #[doc = "[Watcher Update Settings API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-watcher-update-settings)\n\nUpdate Watcher index settings"]
