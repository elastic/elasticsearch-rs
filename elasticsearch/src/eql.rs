...
#[doc = "Builder for the [Eql Delete API](https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-eql-delete)\n\nDelete an async EQL search"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Eql Get API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-async-eql-search-api.html)\n\nGet async EQL search results"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Eql Get Status API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-async-eql-status-api.html)\n\nGet the async EQL status"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Eql Search API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/eql-search-api.html)\n\nGet EQL search results"]
#[derive(Clone, Debug)]
...
impl<'a> Eql<'a> {
    ...
    #[doc = "[Eql Delete API](https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-eql-delete)\n\nDelete an async EQL search"]
    pub fn delete<'b>(&'a self, parts: EqlDeleteParts<'b>) -> EqlDelete<'a, 'b> {
        EqlDelete::new(self.transport(), parts)
    }
    #[doc = "[Eql Get API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-async-eql-search-api.html)\n\nGet async EQL search results"]
    pub fn get<'b>(&'a self, parts: EqlGetParts<'b>) -> EqlGet<'a, 'b> {
        EqlGet::new(self.transport(), parts)
    }
    #[doc = "[Eql Get Status API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-async-eql-status-api.html)\n\nGet the async EQL status"]
    pub fn get_status<'b>(&'a self, parts: EqlGetStatusParts<'b>) -> EqlGetStatus<'a, 'b> {
        EqlGetStatus::new(self.transport(), parts)
    }
    #[doc = "[Eql Search API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/eql-search-api.html)\n\nGet EQL search results"]
