...
#[doc = "Builder for the [Ingest Delete Geoip Database API](https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-ingest-delete-geoip-database)\n\nDelete GeoIP database configurations"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ingest Geo Ip Stats API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/geoip-processor.html)\n\nGet GeoIP statistics"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ingest Get Geoip Database API](https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-ingest-get-geoip-database)\n\nGet GeoIP database configurations"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ingest Processor Grok API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/grok-processor.html)\n\nRun a grok processor"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ingest Put Geoip Database API](https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-ingest-put-geoip-database)\n\nCreate or update a GeoIP database configuration"]
#[derive(Clone, Debug)]
...
#[doc = "Builder for the [Ingest Put Pipeline API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ingest.html)\n\nCreate or update a pipeline"]
#[derive(Clone, Debug)]
...
impl<'a> Ingest<'a> {
    ...
    #[doc = "[Ingest Delete Geoip Database API](https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-ingest-delete-geoip-database)\n\nDelete GeoIP database configurations"]
    ...
    #[doc = "[Ingest Geo Ip Stats API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/geoip-processor.html)\n\nGet GeoIP statistics"]
    pub fn geo_ip_stats<'b>(&'a self) -> IngestGeoIpStats<'a, 'b> {
        IngestGeoIpStats::new(self.transport())
    }
    #[doc = "[Ingest Get Geoip Database API](https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-ingest-get-geoip-database)\n\nGet GeoIP database configurations"]
    ...
    #[doc = "[Ingest Processor Grok API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/grok-processor.html)\n\nRun a grok processor"]
    pub fn processor_grok<'b>(&'a self) -> IngestProcessorGrok<'a, 'b> {
        IngestProcessorGrok::new(self.transport())
    }
    #[doc = "[Ingest Put Geoip Database API](https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-ingest-put-geoip-database)\n\nCreate or update a GeoIP database configuration"]
    ...
    #[doc = "[Ingest Put Pipeline API](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ingest.html)\n\nCreate or update a pipeline"]
