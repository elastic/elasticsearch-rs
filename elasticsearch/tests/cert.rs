...
#[tokio::test]
async fn no_certificate_validation() -> Result<(), failure::Error> {
...
#[tokio::test]
async fn ca_full_certificate_validation() -> Result<(), failure::Error> {
...
#[tokio::test]
async fn ca_certificate_certificate_validation() -> Result<(), failure::Error> {
    let cert = Certificate::from_pem(CA_CERT)?;
    let builder =
        client::create_default_builder().cert_validation(CertificateValidation::Certificate(cert));
...
#[tokio::test]
async fn certificate_fail_certificate_validation() -> Result<(), failure::Error> {
